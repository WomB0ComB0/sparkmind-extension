import { MarkupIcon, getControlId, require_isSymbol } from './chunk-7C4746ZP.js';
import { require_isObject, require_root } from './chunk-M2SMWPXR.js';
import { FB, Tr, gB, wL } from './chunk-Z2TXJYCM.js';
...
var require_conversions = __commonJS({
  'node_modules/.pnpm/color-convert@2.0.1/node_modules/color-convert/conversions.js'(
    ...
    convert2.rgb.ansi16 = (args, saturation = null) => {
      ...
      let ansi =
        30 + ((Math.round(b2 / 255) << 2) | (Math.round(g2 / 255) << 1) | Math.round(r2 / 255));
      if (value === 2) {
        ansi += 60;
      }
      return ansi;
    };
    convert2.hsv.ansi16 = (args) => convert2.rgb.ansi16(convert2.hsv.rgb(args), args[2]);
...
// node_modules/.pnpm/@storybook+blocks@8.2.9_react-dom@18.3.1_react@18.3.1__react@18.3.1_storybook@8.2.9_@babel+pr_vcuxdd3z6cvcl22uyequg2ugxy/node_modules/@storybook/blocks/dist/Color-KGDBMAHA.mjs
...
var s = (e2, r2, t2) => (
  void 0 === r2 && (r2 = 0), void 0 === t2 && (t2 = 1), e2 > t2 ? t2 : e2 < r2 ? r2 : e2
);
      ...
      return [
        (e3) => {
          var r3 = e3.nativeEvent,
            n2 = m2.current;
          if (n2 && (h(r3), !((e4, r4) => r4 && !f(e4))(r3, _2.current) && n2)) {
            if (f(r3)) {
              _2.current = true;
...
var b = (e2, r2, t2) => (
  void 0 === r2 && (r2 = 0), void 0 === t2 && (t2 = Math.pow(10, r2)), Math.round(t2 * e2) / t2
);
...
var C = (e2) => (
  ...
  e2.length < 6
    ...
    : {
        ...
        a: 8 === e2.length ? b(Number.parseInt(e2.substring(6, 8), 16) / 255, 2) : 1,
      }
);
...
var U = (t2) => {
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(T, { hsva: d2, onChange: h2 }),
    import_react.default.createElement(S, {
      hue: d2.h,
      onChange: h2,
...
var Z = (r2) => import_react.default.createElement(U, u({}, r2, { colorModel: W }));
var ee = (r2) => {
  var t2 = r2.className,
    n2 = r2.hsva,
    o2 = r2.onChange,
...
var re = (t2) => {
  ...
  return import_react.default.createElement(
    ...
    u({}, s2, { ref: f2, className: m2 }),
    import_react.default.createElement(T, { hsva: d2, onChange: h2 }),
    import_react.default.createElement(S, { hue: d2.h, onChange: h2 }),
    import_react.default.createElement(ee, {
      hsva: d2,
      onChange: h2,
      className: 'react-colorful__last-control',
    }),
...
var ue = (r2) => import_react.default.createElement(re, u({}, r2, { colorModel: le }));
var Ee = {
...
var He = (r2) => import_react.default.createElement(re, u({}, r2, { colorModel: Ee }));
...
var SwatchColor = Tr.div(({ theme, active }) => ({
  width: 16,
  height: 16,
  boxShadow: active
...
var Input = Tr(wL.Input)(({ theme, readOnly }) => ({
  width: '100%',
  paddingLeft: 30,
  paddingRight: 30,
...
var ToggleIcon = Tr(MarkupIcon)(({ theme }) => ({
  position: 'absolute',
  zIndex: 1,
  top: 6,
  right: 7,
...
var ColorSpace = ((ColorSpace2) => (
  (ColorSpace2.RGB = 'rgb'), (ColorSpace2.HSL = 'hsl'), (ColorSpace2.HEX = 'hex'), ColorSpace2
))(ColorSpace || {});
...
var useColorInput = (initialValue, onChange) => {
  ...
  (0, import_react2.useEffect)(() => {
    ...
    setValue(nextValue),
      setColor(nextColor),
      setColorSpace((nextColor == null ? void 0 : nextColor.colorSpace) || 'hex');
  }, [initialValue]);
  const realValue = (0, import_react2.useMemo)(
    ...
    cycleColorSpace = (0, import_react2.useCallback)(() => {
...
var usePresets = (presetColors, currentColor, colorSpace) => {
  ...
  const presets = (0, import_react2.useMemo)(
    ...
    addPreset = (0, import_react2.useCallback)(
      (color) => {
        (color == null ? void 0 : color.valid) &&
  ...
  return import_react2.default.createElement(
    ...
    import_react2.default.createElement(
      PickerTooltip,
      {
        ...
        tooltip: import_react2.default.createElement(
          TooltipContent,
          null,
          import_react2.default.createElement(Picker, {
              ...
              presets.map((preset, index) =>
                import_react2.default.createElement(
                  gB,
                  {
                    ...
                    hasChrome: false,
                    tooltip: import_react2.default.createElement(Note, {
                      note: preset.keyword || preset.value,
                    }),
                  },
                  import_react2.default.createElement(Swatch, {
      ...
      import_react2.default.createElement(Swatch, { value: realValue, style: { margin: 4 } }),
    ),
    ...
    value ? import_react2.default.createElement(ToggleIcon, { onClick: cycleColorSpace }) : null,
  );
};
var Color_default = ColorControl;
export { ColorControl, Color_default as default };
//# sourceMappingURL=Color-KGDBMAHA-6XLCX452.js.map

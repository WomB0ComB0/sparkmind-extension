...
import { __publicField, __require, __toESM } from './chunk-LK32TJAX.js';
import { require_client_logger } from './chunk-UHU3NK7Q.js';

// node_modules/.pnpm/@storybook+instrumenter@8.2.9_storybook@8.2.9_@babel+preset-env@7.25.3_@babel+core@7.25.2__/node_modules/@storybook/instrumenter/dist/index.mjs
...
var __require2 = ((x) =>
  typeof __require < 'u'
    ? __require
    : typeof Proxy < 'u'
      ? new Proxy(x, { get: (a, b) => (typeof __require < 'u' ? __require : a)[b] })
      : x)(function (x) {
  ...
  '../../node_modules/pretty-format/build/collections.js'(exports) {
    ...
    var getKeysOfEnumerableProperties = (object, compareKeys) => {
      const rawKeys = Object.keys(object),
        keys = compareKeys !== null ? rawKeys.sort(compareKeys) : rawKeys;
      return (
      ...
      serialize = (val, config, indentation, depth, refs, printer) => {
        ...
        if (stringedValue === 'ArrayContaining' || stringedValue === 'ArrayNotContaining')
          return ++depth > config.maxDepth
            ? `[${stringedValue}]`
            : `${stringedValue + SPACE}[${(0, _collections.printListItems)(val.sample, config, indentation, depth, refs, printer)}]`;
        if (stringedValue === 'ObjectContaining' || stringedValue === 'ObjectNotContaining')
          return ++depth > config.maxDepth
            ? `[${stringedValue}]`
            : `${stringedValue + SPACE}{${(0, _collections.printObjectProperties)(val.sample, config, indentation, depth, refs, printer)}}`;
        if (
...
`) !== -1 &&
    ...
    var printChildren = (children, config, indentation, depth, refs, printer) =>
      children
        .map(
          (child) =>
            config.spacingOuter +
  ...
  '../../node_modules/pretty-format/build/plugins/DOMElement.js'(exports) {
    ...
    var _markup = require_markup(),
      ...
      test = (val) => {
        var _a;
        return (
          ((_a = val == null ? void 0 : val.constructor) == null ? void 0 : _a.name) &&
          testNode(val)
        );
      };
    exports.test = test;
...
var require_Immutable = __commonJS({
  '../../node_modules/pretty-format/build/plugins/Immutable.js'(exports) {
    ...
    var _collections = require_collections(),
      ...
      SPACE = ' ',
      LAZY = '…',
      printImmutableEntries = (val, config, indentation, depth, refs, printer, type) =>
    ...
    var printImmutableRecord = (val, config, indentation, depth, refs, printer) => {
      ...
      printImmutableSeq = (val, config, indentation, depth, refs, printer) => {
        ...
        return ++depth > config.maxDepth
          ? printAsLeaf(name)
          : val[IS_KEYED_SENTINEL]
            ? `${name + SPACE}{${val._iter || val._object ? (0, _collections.printIteratorEntries)(val.entries(), config, indentation, depth, refs, printer) : LAZY}}`
            : `${name + SPACE}[${val._iter || val._array || val._collection || val._iterable ? (0, _collections.printIteratorValues)(val.values(), config, indentation, depth, refs, printer) : LAZY}]`;
      },
      printImmutableValues = (val, config, indentation, depth, refs, printer, type) =>
        ++depth > config.maxDepth
          ? printAsLeaf(getImmutableName(type))
  ...
  '../../node_modules/pretty-format/node_modules/react-is/cjs/react-is.development.js'(exports) {
    (() => {
      ...
      var ContextConsumer = REACT_CONTEXT_TYPE,
        ...
        hasWarnedAboutDeprecatedIsAsyncMode = false,
        hasWarnedAboutDeprecatedIsConcurrentMode = false;
...
var require_ReactElement = __commonJS({
  '../../node_modules/pretty-format/build/plugins/ReactElement.js'(exports) {
    ...
    function _getRequireWildcardCache(nodeInterop) {
      ...
      return (_getRequireWildcardCache = (nodeInterop2) =>
        nodeInterop2 ? cacheNodeInterop : cacheBabelInterop)(nodeInterop);
    }
    ...
    var getChildren = (arg, children = []) => (
        Array.isArray(arg)
          ...
          : arg != null && arg !== false && children.push(arg),
        children
      ),
      getType3 = (element) => {
      ...
      serialize = (element, config, indentation, depth, refs, printer) =>
        ++depth > config.maxDepth
          ? (0, _markup.printElementAsLeaf)(getType3(element), config)
          : (0, _markup.printElement)(
              getType3(element),
              (0, _markup.printProps)(
                getPropKeys(element),
...
var require_ReactTestComponent = __commonJS({
  '../../node_modules/pretty-format/build/plugins/ReactTestComponent.js'(exports) {
    ...
    var _markup = require_markup(),
      Symbol2 = globalThis['jest-symbol-do-not-touch'] || globalThis.Symbol,
      testSymbol =
        typeof Symbol2 == 'function' && Symbol2.for ? Symbol2.for('react.test.json') : 245830487,
      getPropKeys = (object) => {
        const { props } = object;
        return props
          ? Object.keys(props)
...
var require_build = __commonJS({
  '../../node_modules/pretty-format/build/index.js'(exports) {
    ...
    function printBasicValue(val, printFunctionName, escapeRegex, escapeString) {
      ...
      return toStringed === '[object WeakMap]'
        ? 'WeakMap {}'
        : toStringed === '[object WeakSet]'
          ? 'WeakSet {}'
          : toStringed === '[object Function]' || toStringed === '[object GeneratorFunction]'
            ? printFunction(val, printFunctionName)
            : toStringed === '[object Symbol]'
              ? printSymbol(val)
              : toStringed === '[object Date]'
                ? isNaN(+val)
                  ? 'Date { NaN }'
                  : toISOString.call(val)
                : toStringed === '[object Error]'
                  ? printError(val)
                  : toStringed === '[object RegExp]'
                    ? escapeRegex
    ...
    function printComplexValue(val, config, indentation, depth, refs, hasCalledToJSON) {
      ...
      const toStringed = toString.call(val);
      return toStringed === '[object Arguments]'
        ? hitMaxDepth
          ? '[Arguments]'
...
${indentationNext}`,
    ...
    var DEFAULT_THEME = {
      ...
      toOptionsSubtype = (options) => options,
      DEFAULT_OPTIONS = toOptionsSubtype({
        callToJSON: true,
        compareKeys: void 0,
        escapeRegex: false,
        escapeString: true,
    ...
    var getColorsHighlight = (options) =>
      ...
      getPrintFunctionName = (options) =>
        (options == null ? void 0 : options.printFunctionName) ?? DEFAULT_OPTIONS.printFunctionName,
      getEscapeRegex = (options) =>
        (options == null ? void 0 : options.escapeRegex) ?? DEFAULT_OPTIONS.escapeRegex,
      getEscapeString = (options) =>
        (options == null ? void 0 : options.escapeString) ?? DEFAULT_OPTIONS.escapeString,
      getConfig = (options) => ({
        callToJSON: (options == null ? void 0 : options.callToJSON) ?? DEFAULT_OPTIONS.callToJSON,
        colors: (options == null ? void 0 : options.highlight)
          ? getColorsHighlight(options)
          : getColorsEmpty(),
        compareKeys:
          typeof (options == null ? void 0 : options.compareKeys) == 'function' ||
          (options == null ? void 0 : options.compareKeys) === null
            ? options.compareKeys
            : DEFAULT_OPTIONS.compareKeys,
        escapeRegex: getEscapeRegex(options),
        escapeString: getEscapeString(options),
        indent: (options == null ? void 0 : options.min)
          ? ''
          : createIndent((options == null ? void 0 : options.indent) ?? DEFAULT_OPTIONS.indent),
...
var require_build2 = __commonJS({
  '../../node_modules/diff-sequences/build/index.js'(exports) {
    ...
    var pkg = 'diff-sequences',
      ...
      extendOverlappablePathsF = (
        ...
        let bF = bStart - aStart,
          aLength = aEnd - aStart,
          baDeltaLength = bEnd - bStart - aLength,
          kMinOverlapF = -baDeltaLength - (d - 1),
          kMaxOverlapF = -baDeltaLength + (d - 1),
        ...
        for (let iF = 0, kF = -d; iF <= nF; iF += 1, kF += 2) {
          const insert = iF === 0 || (iF !== d && aIndexPrev1 < aIndexesF[iF]),
            ...
            bFirst = bF + aFirst - kF,
            nCommonF = countCommonItemsF(aFirst + 1, aEnd, bFirst + 1, bEnd, isCommon),
          ...
          if (
            ...
            if (iR <= iMaxR && aIndexesR[iR] - 1 <= aLast) {
              const bLastPrev = bF + aLastPrev - (insert ? kF + 1 : kF - 1),
                nCommonR = countCommonItemsR(aStart, aLastPrev, bStart, bLastPrev, isCommon),
                aIndexPrevFirst = aLastPrev - nCommonR,
                bIndexPrevFirst = bLastPrev - nCommonR,
                aEndPreceding = aIndexPrevFirst + 1,
                bEndPreceding = bIndexPrevFirst + 1;
              (division.nChangePreceding = d - 1),
                d - 1 === aEndPreceding + bEndPreceding - aStart - bStart
                  ? ((division.aEndPreceding = aStart), (division.bEndPreceding = bStart))
              ...
              return (
                ...
                d - 1 === aEnd + bEnd - aStartFollowing - bStartFollowing
                  ? ((division.aStartFollowing = aEnd), (division.bStartFollowing = bEnd))
      ...
      extendOverlappablePathsR = (
        ...
        for (let iR = 0, kR = d; iR <= nR; iR += 1, kR -= 2) {
          const insert = iR === 0 || (iR !== d && aIndexesR[iR] < aIndexPrev1),
            ...
            aFirst = insert ? aLastPrev : aLastPrev - 1,
            bFirst = bR + aFirst - kR,
            nCommonR = countCommonItemsR(aStart, aFirst - 1, bStart, bFirst - 1, isCommon),
            ...
            if (iF <= iMaxF && aLast - 1 <= aIndexesF[iF]) {
              ...
              if (
                ...
                d === aLast + bLast - aStart - bStart
                  ? ((division.aEndPreceding = aStart), (division.bEndPreceding = bStart))
                  : ((division.aEndPreceding = aLast), (division.bEndPreceding = bLast)),
                (division.nCommonPreceding = nCommonR),
                nCommonR !== 0 &&
                  ((division.aCommonPreceding = aLast), (division.bCommonPreceding = bLast)),
                (division.nChangeFollowing = d - 1),
                d === 1)
              )
                ...
                const bLastPrev = bR + aLastPrev - (insert ? kR - 1 : kR + 1),
                  nCommonF = countCommonItemsF(aLastPrev, aEnd, bLastPrev, bEnd, isCommon);
                (division.nCommonFollowing = nCommonF),
                  nCommonF !== 0 &&
      ...
      divide = (nChange, aStart, aEnd, bStart, bEnd, isCommon, aIndexesF, aIndexesR, division) => {
        ...
        if (((aIndexesF[0] = aStart - 1), (aIndexesR[0] = aEnd), baDeltaLength % 2 === 0)) {
          ...
          let dMin = ((nChange || baDeltaLength) + 1) / 2,
            ...
            d = 1;
          for (
            iMaxF = extendPathsF(d, aEnd, bEnd, bF, isCommon, aIndexesF, iMaxF), d += 1;
            d <= dMax;
            d += 1
          )
            if (
    ...
    function diffSequence(aLength, bLength, isCommon, foundSubsequence) {
      ...
      if (
        (nCommonF !== 0 && foundSubsequence(nCommonF, 0, 0),
        aLength !== nCommonF || bLength !== nCommonF)
      ) {
        const aStart = nCommonF,
          bStart = nCommonF,
          nCommonR = countCommonItemsR(aStart, aLength - 1, bStart, bLength - 1, isCommon),
    ...
    ((global2, factory) => {
      typeof exports == 'object' && typeof module < 'u'
        ...
        : typeof define == 'function' && define.amd
          ...
          : ((global2 = typeof globalThis < 'u' ? globalThis : global2 || self),
            factory((global2.loupe = {})));
    })(exports, (exports2) => {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
      ...
      function colorise(value, styleType) {
        ...
        return color
          ? '\x1B['.concat(color[0], 'm').concat(String(value), '\x1B[').concat(color[1], 'm')
          : String(value);
      }
      function normaliseOptions() {
        var _ref = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
          ...
          maxArrayLength = _ref$maxArrayLength === void 0 ? 1 / 0 : _ref$maxArrayLength,
          _ref$breakLength = _ref.breakLength,
          breakLength = _ref$breakLength === void 0 ? 1 / 0 : _ref$breakLength,
          _ref$seen = _ref.seen,
          seen = _ref$seen === void 0 ? [] : _ref$seen,
          _ref$truncate = _ref.truncate,
          truncate2 = _ref$truncate === void 0 ? 1 / 0 : _ref$truncate,
      ...
      function truncate(string2, length) {
        ...
        return tailLength > length && stringLength > tailLength
          ? tail
          : stringLength > length && stringLength > tailLength
            ? ''.concat(string2.slice(0, length - tailLength)).concat(tail)
            : string2;
      }
      function inspectList(list, options, inspectItem) {
        ...
        if (size === 0) return '';
        for (
          var originalLength = options.truncate, output = '', peek = '', truncated = '', i = 0;
          i < size;
          i += 1
        ) {
          ...
          var string2 = peek || inspectItem(value, options) + (last ? '' : separator),
            nextLength = output.length + string2.length,
          ...
          if (
            ((output += string2),
            !last && !secondToLast && nextLength + peek.length >= originalLength)
          ) {
      ...
      function inspectProperty(_ref2, options) {
        ...
        return (
          ...
          typeof key == 'string'
            ...
            : typeof key != 'number' && (key = '['.concat(options.inspect(key, options), ']')),
      ...
      var getFuncName_1 = getFuncName,
        getArrayName = (array) =>
          typeof Buffer == 'function' && array instanceof Buffer
            ? 'Buffer'
            : array[Symbol.toStringTag]
              ? array[Symbol.toStringTag]
              : getFuncName_1(array.constructor);
      ...
      function inspectMap(map, options) {
        ...
        return size <= 0
          ? 'Map{}'
          : ((options.truncate -= 7),
            'Map{ '.concat(inspectList(mapToEntries(map), options, inspectMapEntry), ' }'));
      }
      var isNaN2 = Number.isNaN || ((i) => i !== i);
      function inspectNumber(number, options) {
        return isNaN2(number)
          ...
          : number === 1 / 0
            ...
            : number === -1 / 0
              ...
              : number === 0
                ...
                : options.stylize(truncate(number, options.truncate), 'number');
      }
      ...
      function inspectSet(set, options) {
        return set.size === 0
          ? 'Set{}'
          : ((options.truncate -= 7),
            'Set{ '.concat(inspectList(arrayFromSet(set), options), ' }'));
      }
      ...
      function inspectString(string2, options) {
        return (
          stringEscapeChars.test(string2) && (string2 = string2.replace(stringEscapeChars, escape)),
          options.stylize("'".concat(truncate(string2, options.truncate - 2), "'"), 'string')
        );
      }
      ...
      function inspectObject(object, options) {
        var properties = Object.getOwnPropertyNames(object),
          symbols = Object.getOwnPropertySymbols ? Object.getOwnPropertySymbols(object) : [];
        if (properties.length === 0 && symbols.length === 0) return '{}';
        if (
          ((options.truncate -= 4),
          (options.seen = options.seen || []),
          options.seen.indexOf(object) >= 0)
        )
          return '[Circular]';
        ...
        return (
          ...
          '{ '.concat(propertyContents).concat(sep).concat(symbolContents, ' }')
        );
      }
      ...
      function inspectClass(value, options) {
        var name = '';
        return (
          toStringTag && toStringTag in value && (name = value[toStringTag]),
          (name = name || getFuncName_1(value.constructor)),
          (!name || name === '_class') && (name = '<Anonymous Class>'),
      ...
      function inspectArguments(args, options) {
        return args.length === 0
          ? 'Arguments[]'
          : ((options.truncate -= 13), 'Arguments[ '.concat(inspectList(args, options), ' ]'));
      }
      var errorKeys = [
        'stack',
        'line',
...
`,
      ...
      function inspectHTML(element, options) {
        var properties = element.getAttributeNames(),
          ...
          head = options.stylize('<'.concat(name), 'special'),
          headClose = options.stylize('>', 'special'),
          tail = options.stylize('</'.concat(name, '>'), 'special');
        ...
        return (
          ...
          ''.concat(head).concat(propertyContents).concat(headClose).concat(children).concat(tail)
        );
      }
      ...
      FakeMap.prototype = {
        ...
        set: function (key, value) {
          Object.isExtensible(key) &&
            Object.defineProperty(key, this.key, { value, configurable: true });
        },
      };
      var constructorMap = new (typeof WeakMap == 'function' ? WeakMap : FakeMap)(),
        ...
        inspectCustom = (value, options, type) =>
          chaiInspect in value && typeof value[chaiInspect] == 'function'
            ? value[chaiInspect](options)
            : nodeInspect && nodeInspect in value && typeof value[nodeInspect] == 'function'
              ? value[nodeInspect](options.depth, options)
              : 'inspect' in value && typeof value.inspect == 'function'
                ? value.inspect(options.depth, options)
                : 'constructor' in value && constructorMap.has(value.constructor)
      ...
      function inspect3(value, options) {
        ...
        var _options = options,
          ...
          type = value === null ? 'null' : _typeof(value);
        ...
        return proto === Object.prototype || proto === null
          ...
          : value && typeof HTMLElement == 'function' && value instanceof HTMLElement
            ? inspectHTML(value, options)
            : 'constructor' in value
              ? value.constructor !== Object
                ? inspectClass(value, options)
                : inspectObject(value, options)
              : value === Object(value)
                ? inspectObject(value, options)
      ...
      function registerConstructor(constructor, inspector) {
        return constructorMap.has(constructor)
          ? false
          : (constructorMap.set(constructor, inspector), true);
      }
...
function joinAlignedDiffsNoExpand(diffs, options) {
  ...
  for (i = 0; i !== iLength; ) {
    ...
    while (i !== iLength && diffs[i][0] === DIFF_DELETE) pushDeleteLine(diffs[i][1]), (i += 1);
    while (i !== iLength && diffs[i][0] === DIFF_INSERT) pushInsertLine(diffs[i][1]), (i += 1);
  }
  return (
...
function joinAlignedDiffsExpand(diffs, options) {
  return diffs
    .map((diff2, i, diffs2) => {
      const line = diff2[1],
        isFirstOrLast = i === 0 || i === diffs2.length - 1;
      switch (diff2[0]) {
        case DIFF_DELETE:
...
function printAnnotation(
  ...
  if (includeChangeCounts) {
    const aCount = String(changeCounts.a),
      ...
      baAnnotationLengthDiff = bAnnotation.length - aAnnotation.length,
      aAnnotationPadding = ' '.repeat(Math.max(0, baAnnotationLengthDiff)),
      bAnnotationPadding = ' '.repeat(Math.max(0, -baAnnotationLengthDiff)),
      baCountLengthDiff = bCount.length - aCount.length,
      aCountPadding = ' '.repeat(Math.max(0, baCountLengthDiff)),
      bCountPadding = ' '.repeat(Math.max(0, -baCountLengthDiff));
    (aRest = `${aAnnotationPadding}  ${aIndicator} ${aCountPadding}${aCount}`),
      (bRest = `${bAnnotationPadding}  ${bIndicator} ${bCountPadding}${bCount}`);
  }
  const a = `${aIndicator} ${aAnnotation}${aRest}`,
    b = `${bIndicator} ${bAnnotation}${bRest}`;
  return `${aColor(a)}
${bColor(b)}
...
function diffLinesUnified2(aLinesDisplay, bLinesDisplay, aLinesCompare, bLinesCompare, options) {
  if (
    ...
    aLinesDisplay.length !== aLinesCompare.length || bLinesDisplay.length !== bLinesCompare.length)
  )
    return diffLinesUnified(aLinesDisplay, bLinesDisplay, options);
  let [diffs, truncated] = diffLinesRaw(aLinesCompare, bLinesCompare, options),
    aIndex = 0,
    bIndex = 0;
  return (
    diffs.forEach((diff2) => {
...
function diffLinesRaw(aLines, bLines, options) {
  let truncate = (options == null ? void 0 : options.truncateThreshold) ?? false,
    truncateThreshold = Math.max(
      Math.floor((options == null ? void 0 : options.truncateThreshold) ?? 0),
      0,
    ),
    aLength = truncate ? Math.min(aLines.length, truncateThreshold) : aLines.length,
    bLength = truncate ? Math.min(bLines.length, truncateThreshold) : bLines.length,
    truncated = aLength !== aLines.length || bLength !== bLines.length,
    isCommon = (aIndex2, bIndex2) => aLines[aIndex2] === bLines[bIndex2],
    diffs = [],
    aIndex = 0,
    bIndex = 0,
  ...
  for (
    (diff$1.default.default || diff$1.default)(aLength, bLength, isCommon, foundSubsequence);
    aIndex !== aLength;
    aIndex += 1
  )
...
var { AsymmetricMatcher, DOMCollection, DOMElement, Immutable, ReactElement, ReactTestComponent } =
...
function diff(a, b, options) {
  ...
  let aType = getType(a),
    expectedType = aType,
    omitDifference = false;
  if (aType === 'object' && typeof a.asymmetricMatch == 'function') {
    if (
      a.$$typeof !== Symbol.for('jest.asymmetricMatcher') ||
      typeof a.getExpectedType != 'function'
    )
      return null;
  ...
  if (expectedType !== getType(b)) {
    const { aAnnotation, aColor, aIndicator, bAnnotation, bColor, bIndicator } =
      ...
      aDisplay = (0, import_pretty_format.format)(a, formatOptions),
      bDisplay = (0, import_pretty_format.format)(b, formatOptions),
      aDiff = `${aColor(`${aIndicator} ${aAnnotation}:`)} 
${aDisplay}`,
      bDiff = `${bColor(`${bIndicator} ${bAnnotation}:`)} 
${bDisplay}`;
    return `${aDiff}
...
function comparePrimitive(a, b, options) {
  const aFormat = (0, import_pretty_format.format)(a, FORMAT_OPTIONS),
    bFormat = (0, import_pretty_format.format)(b, FORMAT_OPTIONS);
...
function getObjectsDifference(a, b, formatOptions, options) {
  const formatOptionsZeroIndent = { ...formatOptions, indent: 0 },
    aCompare = (0, import_pretty_format.format)(a, formatOptionsZeroIndent),
    bCompare = (0, import_pretty_format.format)(b, formatOptionsZeroIndent);
  if (aCompare === bCompare) return getCommonMessage(NO_DIFF_MESSAGE, options);
  {
    const aDisplay = (0, import_pretty_format.format)(a, formatOptions),
      bDisplay = (0, import_pretty_format.format)(b, formatOptions);
          ...
          return typeof value == 'bigint'
            ...
            : typeof value == 'number' && value === 0 && 1 / value < 0
              ...
              : typeof value == 'object' && value !== null
                ? inspect2(value, { depth: 0, colors: false, compact: 3 })
                : String(value);
        }
        case '%d': {
          const value = args[i++];
...
function inspect2(obj, options = {}) {
  return (
    options.truncate === 0 && (options.truncate = Number.POSITIVE_INFINITY),
    loupe.inspect(obj, options)
  );
}
...
function processError(err, diffOptions) {
  ...
  if (
    ...
    err.showDiff || (err.showDiff === void 0 && err.expected !== void 0 && err.actual !== void 0))
  ) {
    const clonedActual = deepClone(err.actual, { forceWritable: true }),
      clonedExpected = deepClone(err.expected, { forceWritable: true }),
  ...
  typeof err.expected != 'string' && (err.expected = stringify(err.expected, 10)),
    typeof err.actual != 'string' && (err.actual = stringify(err.actual, 10));
  try {
...
function replaceAsymmetricMatcher(
  ...
  return isReplaceable(actual, expected)
    ? actualReplaced.has(actual) || expectedReplaced.has(expected)
...
var Instrumenter = class {
  constructor() {
    ...
    (this.channel = import_preview_api.addons.getChannel()),
      (this.state =
        ((_a = import_global.global.window) == null
          ? void 0
          : _a.parent.__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER_STATE__) || {});
    const resetState = ({ storyId, isPlaying = true, isDebugging = false }) => {
    ...
    this.channel.on(import_core_events.FORCE_REMOUNT, resetState),
      this.channel.on(import_core_events.STORY_RENDER_PHASE_CHANGED, ({ storyId, newPhase }) => {
        const { isDebugging } = this.getState(storyId);
        this.setState(storyId, { renderPhase: newPhase }),
          newPhase === 'preparing' && isDebugging && resetState({ storyId }),
          newPhase === 'playing' && resetState({ storyId, isDebugging }),
          newPhase === 'played' &&
            this.setState(storyId, { isLocked: false, isPlaying: false, isDebugging: false }),
          newPhase === 'errored' && this.setState(storyId, { isLocked: false, isPlaying: false });
      }),
      this.channel.on(import_core_events.SET_CURRENT_STORY, () => {
        this.initialized ? this.cleanup() : (this.initialized = true);
      });
    const start = ({ storyId, playUntil }) => {
        this.getState(storyId).isDebugging ||
          this.setState(storyId, ({ calls }) => ({
            calls: [],
            shadowCalls: calls.map((call) => ({ ...call, status: 'waiting' })),
            isDebugging: true,
          }));
      ...
      back = ({ storyId }) => {
        ...
        const log = this.getLog(storyId).filter((call) => !call.ancestors.length),
          last = log.reduceRight(
            (res, item, index) => (res >= 0 || item.status === 'waiting' ? res : index),
            -1,
          );
      ...
      goto = ({ storyId, callId }) => {
        ...
        if (!call && shadowCall && Object.values(resolvers).length > 0) {
          const nextId =
            (_a2 = this.getLog(storyId).find((c) => c.status === 'waiting')) == null
              ? void 0
              : _a2.callId;
          shadowCall.id !== nextId && this.setState(storyId, { playUntil: shadowCall.id }),
  ...
  setState(storyId, update) {
    ...
    (this.state = { ...this.state, [storyId]: { ...state, ...patch } }),
      ((_a = import_global.global.window) == null ? void 0 : _a.parent) &&
        (import_global.global.window.parent.__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER_STATE__ =
          this.state);
  }
  cleanup() {
    var _a;
    ...
    const payload = { controlStates: controlsDisabled, logItems: [] };
        ...
        (acc, key) => {
          ...
          if (typeof (descriptor == null ? void 0 : descriptor.get) == 'function') {
            const getter = () => {
              var _a, _b;
              return (_b =
                (_a = descriptor == null ? void 0 : descriptor.get) == null
                  ? void 0
                  : _a.bind(obj)) == null
                ? void 0
                : _b();
          ...
          return typeof value != 'function'
            ? ((acc[key] = this.instrument(value, { ...options, path: path.concat(key) }, depth)),
              acc)
            : '__originalFn__' in value && typeof value.__originalFn__ == 'function'
              ? ((acc[key] = value), acc)
  ...
  track(method, fn, object, args, options) {
    var _a, _b, _c, _d;
    const storyId =
        ((_a = args == null ? void 0 : args[0]) == null ? void 0 : _a.__storyId__) ||
        ((_d =
          (_c =
            (_b = import_global.global.__STORYBOOK_PREVIEW__) == null
              ? void 0
              : _b.selectionStore) == null
            ? void 0
            : _c.selection) == null
          ? void 0
          : _d.storyId),
    ...
    const id = `${ancestors.slice(-1)[0] || storyId} [${cursor}] ${method}`,
      { path = [], intercept = false, retain = false } = options,
      interceptable = typeof intercept == 'function' ? intercept(method, path) : intercept,
      call = { id, cursor, storyId, ancestors, path, method, args, interceptable, retain },
      result = (interceptable && !ancestors.length ? this.intercept : this.invoke).call(
        this,
        fn,
        object,
        call,
  ...
  intercept(fn, object, call, options) {
    ...
    return !isDebugging || isChainedUpon || playUntil
      ? (playUntil === call.id && this.setState(call.storyId, { playUntil: void 0 }),
  ...
  invoke(fn, object, call, options) {
    const { callRefsByResult, renderPhase } = this.getState(call.storyId),
      ...
      serializeValues = (value, depth, seen) => {
        ...
        if (
          value instanceof ((_a = import_global.global.window) == null ? void 0 : _a.HTMLElement)
        ) {
        ...
        return typeof value == 'function'
          ...
          : typeof value == 'symbol'
            ...
            : typeof value == 'object' &&
                ((_b = value == null ? void 0 : value.constructor) == null ? void 0 : _b.name) &&
                ((_c = value == null ? void 0 : value.constructor) == null ? void 0 : _c.name) !==
                  'Object'
    ...
    call.path.forEach((ref) => {
      (ref == null ? void 0 : ref.__callId__) &&
    ...
    const handleException = (e) => {
      if (e instanceof Error) {
        const { name, message, stack, callId = call.id } = e,
          ...
          exception = { name, message, stack, callId, showDiff, diff: diff2, actual, expected };
        if (
    ...
    try {
      ...
      const finalArgs = (
          options.getArgs ? options.getArgs(call, this.getState(call.storyId)) : call.args
        ).map((arg) =>
          typeof arg != 'function' || Object.keys(arg).length
            ? arg
            : (...args) => {
                const { cursor, ancestors } = this.getState(call.storyId);
                this.setState(call.storyId, { cursor: 0, ancestors: [...ancestors, call.id] });
                let restore = () => this.setState(call.storyId, { cursor, ancestors }),
                  willRestore = false;
                try {
                  const res = arg(...args);
                  return res instanceof Promise
                    ? ((willRestore = true), res.finally(restore))
                    : res;
                } finally {
                  willRestore || restore();
                }
      ...
      return (
        ...
        this.update({ ...info, status: result instanceof Promise ? 'active' : 'done' }),
        result instanceof Promise
          ? result.then(
              (value) => (this.update({ ...info, status: 'done' }), value),
              handleException,
            )
          : result
      );
      ...
      this.setState(call.storyId, ({ calls }) => {
        ...
        return {
          calls: Object.values(callsById).sort((a, b) =>
            a.id.localeCompare(b.id, void 0, { numeric: true }),
          ),
        };
      }),
  ...
  sync(storyId) {
      ...
      const { isLocked, isPlaying } = this.getState(storyId),
        ...
        pausedAt =
          (_a = logItems
            ...
            .find((item) => item.status === 'waiting')) == null
            ? void 0
            : _a.callId,
        hasActive = logItems.some((item) => item.status === 'active');
      if (isLocked || hasActive || logItems.length === 0) {
        const payload2 = { controlStates: controlsDisabled, logItems };
    ...
    this.setState(
      storyId,
      ({ syncTimeout }) => (clearTimeout(syncTimeout), { syncTimeout: setTimeout(synchronize, 0) }),
    );
  }
};
function instrument(obj, options = {}) {
  ...
  try {
    ...
    return (
      (
        (_c =
          (_b = (_a = import_global.global.window) == null ? void 0 : _a.location) == null
            ? void 0
            : _b.search) == null
          ? void 0
          : _c.includes('instrument=true')
      )
        ? (forceInstrument = true)
        : ((_f =
            (_e = (_d = import_global.global.window) == null ? void 0 : _d.location) == null
              ? void 0
              : _e.search) == null
            ? void 0
            : _f.includes('instrument=false')) && (skipInstrument = true),
      (((_g = import_global.global.window) == null ? void 0 : _g.parent) ===
        import_global.global.window &&
        !forceInstrument) ||
      skipInstrument
        ? obj
        : (import_global.global.window &&
            !import_global.global.window.__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER__ &&
            (import_global.global.window.__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER__ =
              new Instrumenter()),
          ((_h = import_global.global.window) == null
            ? void 0
            : _h.__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER__
...
export { instrument };
//# sourceMappingURL=chunk-AYOOYVMV.js.map

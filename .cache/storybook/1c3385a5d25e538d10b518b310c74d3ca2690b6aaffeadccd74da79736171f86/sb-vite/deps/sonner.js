...
// node_modules/.pnpm/sonner@1.5.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/sonner/dist/index.mjs
...
var It = ({ visible: s }) =>
  import_react2.default.createElement(
    "div",
    { className: "sonner-loading-wrapper", "data-visible": s },
    import_react2.default.createElement(
      "div",
...
var $t = import_react2.default.createElement(
  "svg",
  {
...
var Wt = import_react2.default.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 24 24",
...
var _t = import_react2.default.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
var Ut = import_react2.default.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
var ut = class {
  constructor() {
      ...
      return (
        u
          ? (this.toasts = this.toasts.map((d) =>
              d.id === h
                ? (this.publish({ ...d, ...o, id: h, title: t }),
                  { ...d, ...o, id: h, dismissible: g, title: t })
                : d
            ))
          : this.addToast({ title: t, ...n, dismissible: g, id: h }),
        h
      )
    }
    this.dismiss = (o) => (
    ...
    this.promise = (o, t) => {
      ...
      let h = o instanceof Promise ? o : o(),
        u = n !== void 0
      return (
        h
          .then(async (g) => {
              ...
              let b =
                ...
                d =
                  typeof t.description == "function"
                    ? await t.description(`HTTP error! status: ${g.status}`)
                    : t.description
          ...
          .finally(() => {
            var g
            u && (this.dismiss(n), (n = void 0)),
              (g = t.finally) == null || g.call(t)
          }),
        n
      )
    }
...
var se = (s) => {
  ...
  let {
      ...
      classNames: r,
      icons: I,
      closeButtonAriaLabel: at = "Close toast",
      pauseWhenPageIsHidden: k,
      cn: T
    } = s,
    [z, nt] = import_react.default.useState(false),
    [D, H] = import_react.default.useState(false),
    [st, N] = import_react.default.useState(false),
    [M, rt] = import_react.default.useState(false),
    [c, m] = import_react.default.useState(0),
    [y, S] = import_react.default.useState(0),
    A = import_react.default.useRef(null),
    l = import_react.default.useRef(null),
    _ = d === 0,
    J = d + 1 <= g,
    x = t.type,
    P = t.dismissible !== false,
    Mt = t.className || "",
    At = t.descriptionClassName || "",
    G = import_react.default.useMemo(
      () => b.findIndex((a) => a.toastId === t.id) || 0,
      [b, t.id]
    ),
    ...
    mt = import_react.default.useMemo(
      () => t.duration || X || Zt,
      [t.duration, X]
    ),
    it = import_react.default.useRef(0),
    Y = import_react.default.useRef(0),
    pt = import_react.default.useRef(0),
    F = import_react.default.useRef(null),
    [gt, zt] = ot.split("-"),
    ht = import_react.default.useMemo(
      () => b.reduce((a, f, p) => (p >= G ? a : a + f.height), 0),
      [b, G]
    ),
    bt = Dt(),
    jt = t.invert || o,
    lt = x === "loading"
  ;(Y.current = import_react.default.useMemo(() => G * w + ht, [G, ht])),
    ...
    import_react.default.useLayoutEffect(() => {
      ...
      ;(a.style.height = f),
        S(p),
        u((B) =>
          B.find((R) => R.toastId === t.id)
            ? B.map((R) => (R.toastId === t.id ? { ...R, height: p } : R))
  ...
  function Yt() {
    return I != null && I.loading
      ? import_react.default.createElement(
          "div",
          { className: "sonner-loader", "data-visible": x === "loading" },
          I.loading
        )
      : j
        ? import_react.default.createElement(
        ...
        : import_react.default.createElement(It, { visible: x === "loading" })
  }
  return import_react.default.createElement(
    "li",
    {
      ...
      className: T(
        ...
        (yt = t == null ? void 0 : t.classNames) == null ? void 0 : yt.toast,
        r == null ? void 0 : r.default,
        r == null ? void 0 : r[x],
        (xt = t == null ? void 0 : t.classNames) == null ? void 0 : xt[x]
      ),
      "data-sonner-toast": "",
      ...
      onPointerDown: (a) => {
        lt ||
          ...
          a.target.tagName !== "BUTTON" &&
            (N(true), (F.current = { x: a.clientX, y: a.clientY })))
      },
      onPointerUp: () => {
        var B, C, R, dt
        if (M || !P) return
        ...
        let a = Number(
          ...
          f =
            ...
            ((C = A.current) == null ? void 0 : C.getTime()),
          p = Math.abs(a) / f
      ...
      onPointerMove: (a) => {
        ...
        Math.abs(C) > R
          ? (Bt = l.current) == null ||
            Bt.style.setProperty("--swipe-amount", `${f}px`)
          : Math.abs(p) > R && (F.current = null)
      }
    },
    Lt && !t.jsx
      ? import_react.default.createElement(
          "button",
          {
            ...
            className: T(
              ...
              (wt = t == null ? void 0 : t.classNames) == null
                ? void 0
                : wt.closeButton
            )
          },
            ...
            import_react.default.createElement(
              "div",
              {
                ...
                className: T(
                  ...
                  (Rt = t == null ? void 0 : t.classNames) == null
                    ? void 0
                    : Rt.title
                )
              },
              ...
              ? import_react.default.createElement(
                  "button",
                  {
                    ...
                    onClick: (a) => {
                      ...
                      U(t.cancel) &&
                        P &&
                        ((p = (f = t.cancel).onClick) == null || p.call(f, a),
                        L())
                    },
                    className: T(
              ...
              ? import_react.default.createElement(
                  "button",
                  {
                    ...
                    onClick: (a) => {
                      ...
                      U(t.action) &&
                        (a.defaultPrevented ||
                          ((p = (f = t.action).onClick) == null || p.call(f, a),
                          L()))
                    },
                    className: T(
...
var Te = (s) => {
  let {
      ...
      loadingIcon: Z,
      icons: tt,
      containerAriaLabel: et = "Notifications",
      pauseWhenPageIsHidden: X,
      cn: ot = ne
    } = s,
    [w, j] = import_react.default.useState([]),
    W = import_react.default.useMemo(
      () =>
        Array.from(
          new Set(
            [t].concat(w.filter((c) => c.position).map((c) => c.position))
          )
        ),
      [w, t]
    ),
    [r, I] = import_react.default.useState([]),
    [at, k] = import_react.default.useState(false),
    [T, z] = import_react.default.useState(false),
    [nt, D] = import_react.default.useState(
      d !== "system"
        ? d
    ...
    st = n.join("+").replace(/Key/g, "").replace(/Digit/g, ""),
    N = import_react.default.useRef(null),
    M = import_react.default.useRef(false),
    rt = import_react.default.useCallback(
      (c) => {
        var m
        ;((m = w.find((y) => y.id === c.id)) != null && m.delete) ||
          v.dismiss(c.id),
          j((y) => y.filter(({ id: S }) => S !== c.id))
      },
      [w]
    )
  return (
      ...
      d === "system" &&
        ...
        typeof window != "undefined" &&
          window
            ...
            .addEventListener("change", ({ matches: c }) => {
              D(c ? "dark" : "light")
            })
    }, [d]),
    import_react.default.useEffect(() => {
    ...
    import_react.default.useEffect(() => {
      if (H.current)
        return () => {
          N.current &&
            (N.current.focus({ preventScroll: true }),
            (N.current = null),
            (M.current = false))
        }
    }, [H.current]),
      ...
      ? import_react.default.createElement(
          ...
          W.map((c, m) => {
            ...
            return import_react.default.createElement(
              "ol",
              {
                ...
                onFocus: (l) => {
                  ;(l.target instanceof HTMLElement &&
                    ...
                    M.current ||
                    ((M.current = true), (N.current = l.relatedTarget))
                },
                onMouseEnter: () => k(true),
                onMouseMove: () => k(true),
                onMouseLeave: () => {
              ...
              w
                .filter((l) => (!l.position && m === 0) || l.position === c)
                .map((l, _) => {
                  var J, x
                  return import_react.default.createElement(se, {
                    key: l.id,
                    icons: tt,
                    index: _,
                    toast: l,
                    defaultRichColors: q,
                    duration:
                      (J = i == null ? void 0 : i.duration) != null ? J : $,
                    ...
                    visibleToasts: Q,
                    closeButton:
                      (x = i == null ? void 0 : i.closeButton) != null ? x : u,
                    interacting: T,
                    position: c,

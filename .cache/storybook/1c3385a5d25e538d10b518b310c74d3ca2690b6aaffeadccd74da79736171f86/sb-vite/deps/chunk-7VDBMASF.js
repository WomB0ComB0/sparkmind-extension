...
var require_preview_errors = __commonJS({
  '.cache/sb-vite-plugin-externals/@storybook/core/preview-errors.js'(exports, module) {
...
var require_preview_api = __commonJS({
  '.cache/sb-vite-plugin-externals/@storybook/core/preview-api.js'(exports, module) {
...
var ep = (e, n, a, s) => {
  if ((n && typeof n == 'object') || typeof n == 'function')
    for (const p of Xs(n))
      !Zs.call(e, p) &&
        p !== a &&
        yt(e, p, { get: () => n[p], enumerable: !(s = Ws(n, p)) || s.enumerable });
  return e;
};
var pr = (e, n, a) => (
  (a = e != null ? zs(Qs(e)) : {}),
...
var ht = l((tg, Xr) => {
  var zr = Hr(),
    ...
    gc = zr(/* @__PURE__ */ (() => arguments)())
      ? zr
      : (e) => dc(e) && mc.call(e, 'callee') && !Tc.call(e, 'callee');
  Xr.exports = gc;
});
var M = l((rg, Qr) => {
...
var bt = l((ag, on) => {
  ...
  function Oc(e, n) {
    ...
    return (
      (n = n ?? Sc),
      !!n && (a == 'number' || (a != 'symbol' && Ec.test(e))) && e > -1 && e % 1 == 0 && e < n
    );
  }
  r(Oc, 'isIndex');
  on.exports = Oc;
...
var _o = l((Nh, No) => {
  ...
  function nf(e, n) {
    ...
    if (a instanceof Zl) {
      var s = a.__data__;
      if (!ef || s.length < rf - 1) return s.push([e, n]), (this.size = ++a.size), this;
...
var Co = l((Ch, ko) => {
  function gf(e, n) {
    for (var a = -1, s = e == null ? 0 : e.length; ++a < s; ) if (n(e[a], a, e)) return true;
    return false;
  }
  r(gf, 'arraySome');
  ko.exports = gf;
...
var ua = l((ix, ca) => {
  var Zf = aa(),
    ...
    ny = pa ? (e) => (e == null ? [] : ((e = Object(e)), Zf(pa(e), (n) => ry.call(e, n)))) : ey;
  ca.exports = ny;
});
var fa = l((sx, la) => {
  var oy = na(),
  ...
  function ly(e, n, a, s, p, c) {
    ...
    if (q && !R) {
      ...
      w != K &&
        'constructor' in e &&
        'constructor' in n &&
        !(typeof w == 'function' && w instanceof w && typeof K == 'function' && K instanceof K) &&
        (q = false);
    }
...
var jt = l((Ox, Ha) => {
  function Hy(e, n) {
    return (a) => (a == null ? false : a[e] === n && (n !== void 0 || e in Object(a)));
  }
...
var Wa = l((Nx, za) => {
  ...
  function Qy(e) {
    var n = Wy(e);
    return n.length == 1 && n[0][2] ? Xy(n[0][0], n[0][1]) : (a) => a === e || zy(a, e, n);
  }
  r(Qy, 'baseMatches');
  za.exports = Qy;
});
...
var Ye = l((Ix, Qa) => {
  ...
  function sd(e, n) {
    ...
    var a = typeof e;
    return a == 'number' || a == 'symbol' || a == 'boolean' || e == null || od(e)
      ? true
...
var ti = l((jx, ei) => {
  ...
  function Ft(e, n) {
    if (typeof e != 'function' || (n != null && typeof n != 'function')) throw new TypeError(pd);
    var a = r(function () {
      var s = arguments,
...
var ni = l((Lx, ri) => {
  var cd = ti(),
    ud = 500;
  function ld(e) {
    var n = cd(e, (s) => (a.size === ud && a.clear(), s)),
      a = n.cache;
    return n;
  }
  r(ld, 'memoizeCapped');
...
var si = l((Ux, ii) => {
  function Td(e, n) {
    for (var a = -1, s = e == null ? 0 : e.length, p = Array(s); ++a < s; ) p[a] = n(e[a], a, e);
    return p;
  }
  r(Td, 'arrayMap');
  ii.exports = Td;
...
var Ji = l((rb, Pi) => {
  ...
  function Kd(e, n, a) {
    ...
    return c || ++s != p
      ? c
      : ((p = e == null ? 0 : e.length), !!p && Md(p) && Ud(y, p) && (Cd(e) || kd(e)));
  }
  r(Kd, 'hasPath');
  Pi.exports = Kd;
});
  ...
  ((e, n) => {
    typeof Ze == 'object' && typeof Xi < 'u'
      ...
      : typeof define == 'function' && define.amd
        ? define(['exports'], n)
        : ((e = typeof globalThis < 'u' ? globalThis : e || self), n((e.jtpp = {})));
  })(Ze, (e) => {
    function n(t) {
    ...
    r(n, 'tokenToString');
    const Re = class Re2 extends Error {
      constructor(o) {
    ...
    r(g, 'getIdentifier');
    const b = /^(NaN|-?((\d*\.\d+|\d+)([Ee][+-]?\d+)?|Infinity))/;
    function A(t) {
      var o, i;
      return (i = (o = b.exec(t)) === null || o === void 0 ? void 0 : o[0]) !== null && i !== void 0
        ? i
        : null;
    }
    r(A, 'getNumber');
      ...
      ee = class ee2 {
        ...
        static read(o, i = false) {
          ...
          for (const u of k) {
            const f = u(o);
            if (f !== null) {
              const T = Object.assign(Object.assign({}, f), { startOfLine: i });
    ...
    function gs(t) {
      ...
      if (t.type !== 'JsdocTypeNumber' && t.type !== 'JsdocTypeName') throw new p(t);
      return t;
    }
    ...
    const ft = class ft {
      constructor(o, i, u) {
        (this.grammar = o),
          typeof i == 'string' ? (this._lexer = Q.create(i)) : (this._lexer = i),
          (this.baseParser = u);
      }
      get lexer() {
        return this._lexer;
      ...
      parseIntermediateType(o) {
        const i = this.tryParslets(null, o);
      ...
      parseInfixIntermediateType(o, i) {
        ...
        while (u !== null) (o = u), (u = this.tryParslets(o, i));
        return o;
      }
      /**
      ...
      consume(o) {
        return (
          Array.isArray(o) || (o = [o]),
          o.includes(this.lexer.current.type) ? ((this._lexer = this.lexer.advance()), true) : false
        );
      }
      acceptLexerState(o) {
        this._lexer = o.lexer;
    ...
    const Ne = P({
      ...
      _e = P({
        ...
        parsePrefix: r((t) => {
          const o = Number.parseFloat(t.lexer.current.text);
          return (
            t.consume('Number'),
            {
      ...
      hs = P({
        ...
        parsePrefix: r((t) => {
          ...
          const o = t.parseIntermediateType(h.ALL);
      ...
      xs = P({
        ...
        accept: r(
          (t, o) => (t === '?' && Wt(o)) || t === 'null' || t === 'undefined' || t === '*',
          'accept',
        ),
        parsePrefix: r((t) => {
          if (t.consume('null'))
    ...
    function vs({ allowTrailingComma: t }) {
      return P({
        ...
        parseInfix: r((o, i) => {
          ...
          do
            try {
              const f = o.parseIntermediateType(h.PARAMETER_LIST);
              u.push(K(f));
            } catch (f) {
    ...
    const ws = P({
        ...
        parseInfix: r((t, o) => {
          ...
          while (t.consume(','));
          if (!t.consume('>')) throw new Error('Unterminated generic parameter list');
          return {
    ...
    function De({ allowSquareBracketsOnAnyType: t, allowJsdocNamePaths: o, pathGrammar: i }) {
      return r((f, T, x) => {
        ...
        const ir = i !== null ? new B(i, f.lexer, f) : f,
    ...
    function $({ allowedAdditionalTokens: t }) {
      return P({
        name: 'nameParslet',
        accept: r(
          (o) => o === 'Identifier' || o === 'this' || o === 'new' || t.includes(o),
          'accept',
        ),
        parsePrefix: r((o) => {
          const { type: i, text: u } = o.lexer.current;
          return (
            o.consume(i),
            {
              type: 'JsdocTypeName',
      ...
      return P({
        ...
        parsePrefix: r((i) => {
          ...
          if (i.consume('StringValue'))
            ...
            let D = '',
              _ = ['Identifier', '@', '/'];
            while (_.some((j) => i.consume(j))) (D += T.text), (T = i.lexer.current);
            f = {
              type: 'JsdocTypeSpecialNamePath',
              value: D,
              specialType: u,
    ...
    function at({
      ...
      return P({
        ...
        parsePrefix: r((f) => {
          const T = f.consume('new');
          f.consume('function');
          const x = f.lexer.current.type === '(';
          if (!x) {
    ...
    function it({ allowPostfix: t, allowEnclosingBrackets: o }) {
      return P({
        ...
        parsePrefix: r((i) => {
          ...
          const u = o && i.consume('[');
          try {
            const f = i.parseType(h.PREFIX);
            if (u && !i.consume(']')) throw new Error("Unterminated variadic type. Missing ']'");
            return {
            ...
            if (f instanceof a) {
              if (u) throw new Error('Empty square brackets for variadic are not allowed.');
              return {
                type: 'JsdocTypeVariadic',
                meta: {
                  position: void 0,
    ...
    const Qt = P({
        ...
        parseInfix: r((t, o) => {
          ...
          if (!t.consume(')')) {
            const u = t.parseIntermediateType(h.SYMBOL);
        ...
        parsePrefix: r((i) => {
          ...
          if (!i.consume('}')) {
            ...
            for (;;) {
              ...
              let S = false;
              if (
                (x.type === 'JsdocTypeNullable' && ((S = true), (x = x.element)),
      ...
      return P({
        ...
        parseInfix: r((f, T) => {
          ...
          u && T.type === 'JsdocTypeNullable' && ((S = true), (T = T.element)),
            i && T.type === 'JsdocTypeReadonlyProperty' && ((D = true), (T = T.element));
          const _ = (x = f.baseParser) !== null && x !== void 0 ? x : f;
          if (
            ...
            const Le = _.parseType(h.KEY_VALUE);
            return (
            ...
            if (!o) throw new p(T);
            _.consume(':');
            const j = _.parseType(h.KEY_VALUE);
            return (
              f.acceptLexerState(_),
              {
      ...
      return P({
        ...
        parseInfix: r((i, u) => {
          let f = false,
            T = false;
          if (
            (t && u.type === 'JsdocTypeNullable' && ((f = true), (u = u.element)),
            o &&
            ...
            throw new p(u);
          i.consume(':');
          const x = i.parseType(h.KEY_VALUE);
          return {
    ...
    function As({ allowQuestionMark: t }) {
      return P({
        ...
        parsePrefix: r((o) => {
          ...
          const u = o.parseIntermediateType(h.ALL);
          if (
    ...
    const Ns = P({
      ...
      _s = P({
        ...
        parsePrefix: r((t) => {
          ...
          const o = t.parseType(h.PREFIX);
          if (o.type !== 'JsdocTypeStringValue')
            throw new Error('Only string values are allowed as paths for imports');
          if (!t.consume(')')) throw new Error('Missing closing parenthesis after import keyword');
          return {
      ...
      js = P({
        ...
        accept: r((t) => t === '[', 'accept'),
        parsePrefix: r((t) => {
          if (t.baseParser === void 0) throw new Error('Only allowed inside object grammar');
          t.consume('[');
          const o = t.lexer.current.text;
          t.consume('Identifier');
          let i;
          if (t.consume(':')) {
            const u = t.baseParser;
    ...
    function or() {
      return {
        ...
        JsdocTypeFunction: r((t, o) => {
          if (t.arrow) {
            if (t.returnType === void 0) throw new Error('Arrow function needs a return type.');
        ...
        JsdocTypeVariadic: r(
          (t, o) => (t.meta.position === void 0 ? '...' : Ie(t.meta.position, o(t.element), '...')),
          'JsdocTypeVariadic',
        ),
        ...
        JsdocTypeGeneric: r((t, o) => {
          if (t.meta.brackets === 'square') {
            const i = t.elements[0],
              u = o(i);
            return i.type === 'JsdocTypeUnion' || i.type === 'JsdocTypeIntersection'
              ? `(${u})[]`
              : `${u}[]`;
          } else return `${o(t.left)}${t.meta.dot ? '.' : ''}<${t.elements.map(o).join(', ')}>`;
        }, 'JsdocTypeGeneric'),
        ...
        JsdocTypeObjectField: r((t, o) => {
          ...
          return (
            ...
            typeof t.key == 'string' ? (i += G(t.key, t.meta.quote)) : (i += o(t.key)),
            t.optional && (i += '?'),
        ...
        JsdocTypeObject: r(
          (t, o) => `{${t.elements.map(o).join((t.meta.separator === 'comma' ? ',' : ';') + ' ')}}`,
          'JsdocTypeObject',
        ),
    ...
    const Vs = {
      ...
      JsdocTypeObject: r((t, o) => {
        ...
        for (const u of t.elements)
          u.type !== 'JsdocTypeObjectField' && u.type !== 'JsdocTypeJsdocObjectField'
            ? i.fields.push({
                type: 'FieldType',
                key: o(u),
                value: void 0,
      ...
      JsdocTypeNamePath: r((t, o) => {
        ...
        const f = t.pathType === 'inner' ? '~' : t.pathType === 'instance' ? '#' : '.';
        return Y(`${i.name}${f}${u}`);
      }, 'JsdocTypeNamePath'),
      JsdocTypeSymbol: r((t) => {
        let o = '',
        ...
        return (
          (i == null ? void 0 : i.type) === 'JsdocTypeVariadic' &&
            (i.meta.position === 'prefix' ? (o = '...') : (u = true), (i = i.element)),
          (i == null ? void 0 : i.type) === 'JsdocTypeName'
            ? (o += i.value)
            : (i == null ? void 0 : i.type) === 'JsdocTypeNumber' && (o += i.value.toString()),
          u && (o += '...'),
          Y(`${t.value}(${o})`)
        );
      }, 'JsdocTypeSymbol'),
    ...
    const $s = {
      ...
      JsdocTypeNamePath: r((t, o) => {
        let i = false,
          u,
          f;
        t.right.type === 'JsdocTypeSpecialNamePath' && t.right.specialType === 'event'
    ...
    function lt(t, o, i, u, f) {
      ...
      for (const x of T) {
        const S = t[x];
        if (S !== void 0)
          if (Array.isArray(S)) for (const D of S) lt(D, t, x, u, f);
          else lt(S, t, x, u, f);
      }
...
var te = r((e) => {
  ...
  switch ((typeof a < 'u' && (s.raw = a), e.name)) {
    ...
    case 'union':
      let p;
      return (
        ((_a = e.elements) == null ? void 0 : _a.every((c) => c.name === 'literal'))
          ? (p = {
              ...s,
              name: 'enum',
          ...
          : (p = { ...s, name: n, value: (_c = e.elements) == null ? void 0 : _c.map(te) }),
        p
      );
    case 'intersection':
  ...
  switch ((typeof a < 'u' && (s.raw = a), e.name)) {
    ...
    case 'union':
      return ((_a = e.elements) == null ? void 0 : _a.every(ip))
        ? { ...s, name: 'enum', value: (_b = e.elements) == null ? void 0 : _b.map(sp) }
        : { ...s, name: n, value: (_c = e.elements) == null ? void 0 : _c.map(re) };
    case 'intersection':
...
var wm = /^\(.*\) => /;
var fe = r((e) => {
  const { name: n, raw: a, computed: s, value: p } = e,
    c = {};
  switch ((typeof a < 'u' && (c.raw = a), n)) {
    case 'enum': {
      const d = s ? p : p.map((m) => ke(m.value));
    ...
    default: {
      if ((n == null ? void 0 : n.indexOf('|')) > 0)
        try {
          const g = n.split('|').map((b) => JSON.parse(b));
...
var He = r((e) => {
  const { type: n, tsType: a, flowType: s } = e;
  try {
...
function zi(e = {}) {
  return Object.assign(
    { tag: '', name: '', type: '', optional: false, description: '', problems: [], source: [] },
    e,
  );
}
r(zi, 'seedSpec');
...
function Mt({ fence: e = '```' } = {}) {
  ...
  return r((p) => {
    let c = [[]],
      y = false;
    for (const d of p)
      Sm.test(d.tokens.description) && !y ? c.push([d]) : c[c.length - 1].push(d),
...
function Vt({ startLine: e = 0, markers: n = F } = {}) {
  ...
  return r((c) => {
    ...
    if (
      ...
      return s++, null;
    const m = y.trimRight().endsWith(n.end);
    if (
      (d.delimiter === '' &&
        y.startsWith(n.delim) &&
        !y.startsWith(n.end) &&
        ((d.delimiter = n.delim), (y = y.slice(n.delim.length)), ([d.postDelimiter, y] = V(y))),
      m)
    ) {
      const g = y.trimRight();
...
function Kt({ tokenizers: e }) {
  return r((a) => {
    ...
    for (const c of e)
      if (
        ((p = c(p)),
        !((s = p.problems[p.problems.length - 1]) === null || s === void 0) && s.critical)
      )
        break;
    return p;
  }, 'parseSpec');
...
function We(e = 'compact') {
  ...
  return (a) => {
    let s = 0,
      p = [];
    for (const [d, { tokens: m }] of a.source.entries()) {
      let g = '';
      if (d === 0 && m.description[0] !== '{') return a;
      for (const b of m.description)
    ...
    for (const [d, [m, g]] of p.entries())
      (m.type = g),
        ...
        c.push(m.type);
    return (
      (c[0] = c[0].slice(1)), (c[c.length - 1] = c[c.length - 1].slice(0, -1)), (a.type = n(c)), a
    );
  };
}
r(We, 'typeTokenizer');
...
function Xe() {
  const e = r((n, { tokens: a }, s) => (a.type === '' ? n : s), 'typeEnd');
  return (n) => {
    const { tokens: a } = n.source[n.source.reduce(e, 0)],
...
function $t({
  ...
  const c = Vt({ startLine: e, markers: s }),
    y = Mt({ fence: n }),
    d = Kt({ tokenizers: p }),
    m = Bt(a);
  return (g) => {
...
var ps = r((e, n) => {
  const { flowType: a, description: s, required: p, defaultValue: c } = n;
  return {
    name: e,
    type: is(a),
    required: p,
...
var ls = r((e, n) => {
  const { description: a, required: s } = n;
  return {
    name: e,
    type: cs(n),
    required: s,
...
function fs(e, n, a) {
  const { description: s, required: p, defaultValue: c } = a;
  return {
    name: e,
    type: Wm(n),
    required: p,
...
function et(e, n) {
  ...
  if (n == null ? void 0 : n.includesJsDoc) {
    const { description: a, extractedTags: s } = n;
...
//# sourceMappingURL=chunk-7VDBMASF.js.map

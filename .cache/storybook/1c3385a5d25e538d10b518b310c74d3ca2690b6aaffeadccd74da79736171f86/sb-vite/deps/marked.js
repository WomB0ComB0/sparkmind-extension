...
// node_modules/.pnpm/marked@14.1.1/node_modules/marked/lib/marked.esm.js
...
${currentText}`
  ...
  list(src) {
    ...
    if (cap) {
      ...
      list2.items[list2.items.length - 1].raw =
        list2.items[list2.items.length - 1].raw.trimEnd()
      list2.items[list2.items.length - 1].text =
        list2.items[list2.items.length - 1].text.trimEnd()
...
var _Renderer = class {
  ...
  code({ text, lang, escaped }) {
    var _a
    const langString =
      (_a = (lang || "").match(/^\S*/)) == null ? void 0 : _a[0]

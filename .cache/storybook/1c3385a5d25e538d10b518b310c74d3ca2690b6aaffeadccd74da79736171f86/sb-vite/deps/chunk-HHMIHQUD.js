...
import { __export } from './chunk-KKI3K6YF.js';
import { renderElement, unmountElement } from './chunk-LDYIVF4Z.js';
import { __toESM } from './chunk-LK32TJAX.js';
import { require_react } from './chunk-VMU3GUP3.js';

// node_modules/.pnpm/@storybook+react@8.2.9_react-dom@18.3.1_react@18.3.1__react@18.3.1_storybook@8.2.9_@babel+pre_7f5rxr3ac3pw57jcaavngba25q/node_modules/@storybook/react/dist/chunk-SXKPGB5T.mjs
...
var Wrapper = (FRAMEWORK_OPTIONS == null ? void 0 : FRAMEWORK_OPTIONS.strictMode)
...
var mount = (context) => async (ui) => (
  ui != null && (context.originalStoryFn = () => ui), await context.renderToCanvas(), context.canvas
);
var parameters = { renderer: 'react' };

export { entry_preview_exports, render, renderToCanvas, mount, parameters };
//# sourceMappingURL=chunk-HHMIHQUD.js.map

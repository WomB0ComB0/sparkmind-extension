...
// node_modules/.pnpm/@storybook+react-dom-shim@8.2.9_react-dom@18.3.1_react@18.3.1__react@18.3.1_storybook@8.2.9_@_quuva4msazjmv74zmmka7lalja/node_modules/@storybook/react-dom-shim/dist/react-18.mjs
...
var renderElement = async (node, el, rootOptions) => {
  ...
  return new Promise((resolve) => {
    root.render(
      import_react.default.createElement(WithCallback, { callback: () => resolve(null) }, node),
    );
  });
};
...
var getReactRoot = async (el, rootOptions) => {
  ...
  return (
    root || ((root = import_client.default.createRoot(el, rootOptions)), nodes.set(el, root)), root
  );
};

export { renderElement, unmountElement };
//# sourceMappingURL=chunk-LDYIVF4Z.js.map

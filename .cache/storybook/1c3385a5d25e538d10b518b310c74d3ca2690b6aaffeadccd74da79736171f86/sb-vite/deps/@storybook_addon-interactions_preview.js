...
// node_modules/.pnpm/@storybook+instrumenter@8.2.9_storybook@8.2.9_@babel+preset-env@7.25.4_@babel+core@7.25.2__/node_modules/@storybook/instrumenter/dist/index.mjs
  ...
  "../../node_modules/pretty-format/build/plugins/DOMElement.js"(exports) {
    ...
    var _markup = require_markup(),
      ...
      test = (val) => {
        var _a
        return (
          ((_a = val == null ? void 0 : val.constructor) == null
            ? void 0
            : _a.name) && testNode(val)
        )
      }
    exports.test = test
...
${indentationNext}`
    ...
    var getColorsHighlight = (options) =>
      ...
      getPrintFunctionName = (options) =>
        (options == null ? void 0 : options.printFunctionName) ??
        DEFAULT_OPTIONS.printFunctionName,
      getEscapeRegex = (options) =>
        (options == null ? void 0 : options.escapeRegex) ??
        DEFAULT_OPTIONS.escapeRegex,
      getEscapeString = (options) =>
        (options == null ? void 0 : options.escapeString) ??
        DEFAULT_OPTIONS.escapeString,
      getConfig = (options) => ({
        callToJSON:
          (options == null ? void 0 : options.callToJSON) ??
          DEFAULT_OPTIONS.callToJSON,
        colors: (options == null ? void 0 : options.highlight)
          ? getColorsHighlight(options)
          : getColorsEmpty(),
        compareKeys:
          typeof (options == null ? void 0 : options.compareKeys) ==
            "function" ||
        ...
        indent: (options == null ? void 0 : options.min)
          ? ""
          : createIndent(
              (options == null ? void 0 : options.indent) ??
                DEFAULT_OPTIONS.indent
            ),
        maxDepth:
          (options == null ? void 0 : options.maxDepth) ??
          DEFAULT_OPTIONS.maxDepth,
        maxWidth:
          (options == null ? void 0 : options.maxWidth) ??
        ...
        printBasicPrototype:
          (options == null ? void 0 : options.printBasicPrototype) ?? true,
  ...
  "../../node_modules/diff-sequences/build/index.js"(exports) {
    ...
    var pkg = "diff-sequences",
      ...
      countCommonItemsR = (aStart, aIndex, bStart, bIndex, isCommon) => {
        ...
        for (
          ;
          aStart <= aIndex && bStart <= bIndex && isCommon(aIndex, bIndex);
      ...
      extendOverlappablePathsF = (
        ...
        for (let iF = 0, kF = -d; iF <= nF; iF += 1, kF += 2) {
          let insert = iF === 0 || (iF !== d && aIndexPrev1 < aIndexesF[iF]),
      ...
      extendOverlappablePathsR = (
        ...
        for (let iR = 0, kR = d; iR <= nR; iR += 1, kR -= 2) {
          let insert = iR === 0 || (iR !== d && aIndexesR[iR] < aIndexPrev1),
          ...
          if (
            ...
            if (iF <= iMaxF && aLast - 1 <= aIndexesF[iF]) {
              ...
              if (
                ...
                let bLastPrev = bR + aLastPrev - (insert ? kR - 1 : kR + 1),
                  nCommonF = countCommonItemsF(
                    aLastPrev,
                    aEnd,
                    bLastPrev,
      ...
      findSubsequences = (
        ...
        if (bEnd - bStart < aEnd - aStart) {
          if (
            ((transposed = !transposed), transposed && callbacks.length === 1)
          ) {
            let { foundSubsequence: foundSubsequence2, isCommon: isCommon2 } =
              callbacks[0]
            callbacks[1] = {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
      ...
      function normaliseOptions() {
        var _ref =
          ...
          maxArrayLength =
            _ref$maxArrayLength === void 0 ? 1 / 0 : _ref$maxArrayLength,
      ...
      var getFuncName_1 = getFuncName,
        getArrayName = function (array) {
          return typeof Buffer == "function" && array instanceof Buffer
            ? "Buffer"
      ...
      function inspectTypedArray(array, options) {
        ...
        for (var output = "", i = 0; i < array.length; i++) {
          var string2 = ""
            .concat(
              options.stylize(truncate(array[i], options.truncate), "number")
            )
      ...
      function inspectBigInt(number, options) {
        ...
        return (
          nums !== truncator && (nums += "n"), options.stylize(nums, "bigint")
        )
      }
      ...
      function inspectString(string2, options) {
        return (
          stringEscapeChars.test(string2) &&
      ...
      var toStringTag =
        typeof Symbol < "u" && Symbol.toStringTag ? Symbol.toStringTag : false
      ...
      function inspectArguments(args, options) {
        return args.length === 0
          ? "Arguments[]"
          : ((options.truncate -= 13),
            "Arguments[ ".concat(inspectList(args, options), " ]"))
      }
      var errorKeys = [
        "stack",
        "line",
...
`
      ...
      var constructorMap = new (
        ...
        inspectCustom = function (value, options, type) {
          return chaiInspect in value && typeof value[chaiInspect] == "function"
      ...
      function inspect3(value, options) {
        ...
        if (
          (type === "object" && (type = toString$1.call(value).slice(8, -1)),
          baseTypesMap[type])
        )
      ...
      function registerStringTag(stringTag, inspector) {
        return stringTag in stringTagMap
          ? false
          : ((stringTagMap[stringTag] = inspector), true)
      }
...
function joinAlignedDiffsNoExpand(diffs, options) {
  ...
  for (; i !== iLength; ) {
    ...
    if (iStart !== i)
      if (iStart === 0)
        i > nContextLines &&
          ((jLength -= i - nContextLines), (hasExcessAtStartOrEnd = true))
      else if (i === iLength) {
        let n = i - iStart
        n > nContextLines &&
          ((jLength -= n - nContextLines), (hasExcessAtStartOrEnd = true))
      } else {
        let n = i - iStart
        n > nContextLines2 &&
          ((jLength -= n - nContextLines2), (nExcessesBetweenChanges += 1))
      }
    for (; i !== iLength && diffs[i][0] !== DIFF_EQUAL; ) i += 1
  }
...
function printAnnotation(
  ...
  let a = `${aIndicator} ${aAnnotation}${aRest}`,
...
function diffLinesRaw(aLines, bLines, options) {
  let truncate =
      (options == null ? void 0 : options.truncateThreshold) ?? false,
  ...
  for (
    (diff$1.default.default || diff$1.default)(
      aLength,
      bLength,
      isCommon,
      foundSubsequence
...
function diff(a, b, options) {
  ...
  if (expectedType !== getType(b)) {
    let { aAnnotation, aColor, aIndicator, bAnnotation, bColor, bIndicator } =
...
function comparePrimitive(a, b, options) {
  let aFormat = (0, import_pretty_format.format)(a, FORMAT_OPTIONS),
...
function getObjectsDifference(a, b, formatOptions, options) {
  ...
  {
    let aDisplay = (0, import_pretty_format.format)(a, formatOptions),
      bDisplay = (0, import_pretty_format.format)(b, formatOptions)
...
function getOwnProperties(obj) {
  ...
  return isFinalObj(obj)
    ? []
    : (collectOwnProperties(obj, ownProps), Array.from(ownProps))
}
...
function processError(err, diffOptions) {
  ...
  if (
    ...
    let clonedActual = deepClone(err.actual, { forceWritable: true }),
...
function isAsymmetricMatcher(data) {
  return (
    getType2(data) === "Object" && typeof data.asymmetricMatch == "function"
  )
}
...
var Instrumenter = class {
  constructor() {
    ...
    let resetState = ({ storyId, isPlaying = true, isDebugging = false }) => {
      ...
      this.setState(storyId, {
        ...
        chainedCallIds: isDebugging
          ? state.chainedCallIds
          : /* @__PURE__ */ new Set(),
    ...
    this.channel.on(import_core_events.FORCE_REMOUNT, resetState),
      this.channel.on(
        import_core_events.STORY_RENDER_PHASE_CHANGED,
        ({ storyId, newPhase }) => {
          ...
          this.setState(storyId, { renderPhase: newPhase }),
            ...
            newPhase === "errored" &&
              this.setState(storyId, { isLocked: false, isPlaying: false })
        }
      ),
    ...
    let start = ({ storyId, playUntil }) => {
        ...
        this.setState(storyId, ({ shadowCalls }) => {
          ...
          this.channel.emit(import_core_events.FORCE_REMOUNT, {
            storyId,
            isDebugging: true
          })
      },
      back = ({ storyId }) => {
        ...
        let log = this.getLog(storyId).filter((call) => !call.ancestors.length),
          last = log.reduceRight(
            (res, item, index) =>
              res >= 0 || item.status === "waiting" ? res : index,
            -1
          )
        start({
          storyId,
          playUntil: (_a2 = log[last - 1]) == null ? void 0 : _a2.callId
        })
      },
      goto = ({ storyId, callId }) => {
        var _a2
        ...
        if (!call && shadowCall && Object.values(resolvers).length > 0) {
          let nextId =
            (_a2 = this.getLog(storyId).find((c) => c.status === "waiting")) ==
            null
              ? void 0
              : _a2.callId
      ...
      next = ({ storyId }) => {
        ...
        this.setState(storyId, { playUntil: void 0, isDebugging: false }),
          Object.values(this.getState(storyId).resolvers).forEach((resolve) =>
            resolve()
          )
      }
    ...
    return (
      ...
      keys.reduce(
        (acc, key) => {
          ...
          if (
            typeof (descriptor == null ? void 0 : descriptor.get) == "function"
          ) {
            let getter = () => {
              var _a, _b
              return (_b =
          ...
          return typeof value != "function"
            ...
            : "__originalFn__" in value &&
                typeof value.__originalFn__ == "function"
              ? ((acc[key] = value), acc)
              : ((acc[key] = (...args) =>
  ...
  track(method, fn, object, args, options) {
    var _a, _b, _c, _d
    let storyId =
        ((_a = args == null ? void 0 : args[0]) == null
          ? void 0
          : _a.__storyId__) ||
        ((_d =
          (_c =
    ...
    let id = `${ancestors.slice(-1)[0] || storyId} [${cursor}] ${method}`,
      ...
      interceptable =
        typeof intercept == "function" ? intercept(method, path) : intercept,
      call = {
        id,
        cursor,
        storyId,
      ...
      result = (
        interceptable && !ancestors.length ? this.intercept : this.invoke
  ...
  invoke(fn, object, call, options) {
    let { callRefsByResult, renderPhase } = this.getState(call.storyId),
      ...
      serializeValues = (value, depth, seen) => {
        ...
        if (
          value instanceof
          ((_a = import_global.global.window) == null ? void 0 : _a.HTMLElement)
        ) {
          let { prefix, localName, id, classList, innerText } = value,
            classNames = Array.from(classList)
          return {
            __element__: { prefix, localName, id, classNames, innerText }
          }
        }
        return typeof value == "function"
          ? {
          ...
          : typeof value == "symbol"
            ...
            : typeof value == "object" &&
                ((_b = value == null ? void 0 : value.constructor) == null
                  ? void 0
                  : _b.name) &&
                ((_c = value == null ? void 0 : value.constructor) == null
                  ? void 0
                  : _c.name) !== "Object"
  ...
  sync(storyId) {
    ...
    this.setState(
      storyId,
      ({ syncTimeout }) => (
        clearTimeout(syncTimeout), { syncTimeout: setTimeout(synchronize, 0) }
      )
    )
  }
}
  ...
  try {
    ...
    return (
      (
        ...
        : ((_f =
            (_e =
              (_d = import_global.global.window) == null
                ? void 0
                : _d.location) == null
              ? void 0
              : _e.search) == null
...
// node_modules/.pnpm/@storybook+addon-interactions@8.2.9_storybook@8.2.9_@babel+preset-env@7.25.4_@babel+core@7.25_ltdp2d4pjnrvazvuocg2uadgxy/node_modules/@storybook/addon-interactions/dist/preview.mjs

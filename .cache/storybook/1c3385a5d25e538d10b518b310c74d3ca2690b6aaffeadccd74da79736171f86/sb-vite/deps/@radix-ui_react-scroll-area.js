...
var ScrollArea = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(ScrollAreaProvider, {
...
var ScrollAreaScrollbar = React2.forwardRef((props, forwardedRef) => {
  ...
  return context.type === "hover"
    ? (0, import_jsx_runtime2.jsx)(ScrollAreaScrollbarHover, {
        ...scrollbarProps,
        ref: forwardedRef,
        forceMount
      })
    : context.type === "scroll"
      ? (0, import_jsx_runtime2.jsx)(ScrollAreaScrollbarScroll, {
          ...scrollbarProps,
          ref: forwardedRef,
          forceMount
        })
      : context.type === "auto"
        ? (0, import_jsx_runtime2.jsx)(ScrollAreaScrollbarAuto, {
            ...scrollbarProps,
            ref: forwardedRef,
            forceMount
          })
        : context.type === "always"
          ? (0, import_jsx_runtime2.jsx)(ScrollAreaScrollbarVisible, {
              ...scrollbarProps,
              ref: forwardedRef
            })
          : null
...
var ScrollAreaScrollbarHover = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Presence, {
    ...
    children: (0, import_jsx_runtime2.jsx)(ScrollAreaScrollbarAuto, {
...
var ScrollAreaScrollbarScroll = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Presence, {
    ...
    children: (0, import_jsx_runtime2.jsx)(ScrollAreaScrollbarVisible, {
...
var ScrollAreaScrollbarVisible = React2.forwardRef((props, forwardedRef) => {
  ...
  if (orientation === "horizontal") {
    return (0, import_jsx_runtime2.jsx)(ScrollAreaScrollbarX, {
      ...commonProps,
      ref: forwardedRef,
  ...
  if (orientation === "vertical") {
    return (0, import_jsx_runtime2.jsx)(ScrollAreaScrollbarY, {
      ...commonProps,
      ref: forwardedRef,
      onThumbPositionChange: () => {
        if (context.viewport && thumbRef.current) {
...
var ScrollAreaScrollbarX = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(ScrollAreaScrollbarImpl, {
...
var ScrollAreaScrollbarImpl = React2.forwardRef((props, forwardedRef) => {
  ...
  useResizeObserver(context.content, handleResize)
  return (0, import_jsx_runtime2.jsx)(ScrollbarProvider, {
    scope: __scopeScrollArea,
    scrollbar,
    hasThumb,
...
var ScrollAreaThumb = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Presence, {
    ...
    children: (0, import_jsx_runtime2.jsx)(ScrollAreaThumbImpl, {
      ref: forwardedRef,
      ...thumbProps
    })
  })
...
var ScrollAreaCorner = React2.forwardRef((props, forwardedRef) => {
  ...
  return hasCorner
    ? (0, import_jsx_runtime2.jsx)(ScrollAreaCornerImpl, {
        ...props,
        ref: forwardedRef
      })
    : null
...
var ScrollAreaCornerImpl = React2.forwardRef((props, forwardedRef) => {
  ...
  useResizeObserver(context.scrollbarX, () => {
    var _a
    const height2 =
      ((_a = context.scrollbarX) == null ? void 0 : _a.offsetHeight) || 0
  ...
  useResizeObserver(context.scrollbarY, () => {
    var _a
    const width2 =
      ((_a = context.scrollbarY) == null ? void 0 : _a.offsetWidth) || 0

try {
  (() => {
    ...
    var Yg = __STORYBOOK_CLIENT_LOGGER__,
      { deprecate: rt, logger: Se, once: ct, pretty: Kg } = __STORYBOOK_CLIENT_LOGGER__;
...
Incoming: ${r}`),
    ...
    c(Ip, 'useGlobals');
    var i2 = c(({ name: t, parameterName: e, wrapper: r, skipIfNoParametersOrOptions: n = !1 }) => {
        let o = c(
          (a) => (i, s) => {
...
`)
    ...
    var u0 = __STORYBOOK_CLIENT_LOGGER__,
      { deprecate: l0, logger: c0, once: Tf, pretty: p0 } = __STORYBOOK_CLIENT_LOGGER__;
    var sr = (() => {
      let t;
      return (
        typeof window < 'u'
...
`,
    ...
    var Me = (function (t) {
      ...
      function e(r) {
        for (var n, o = arguments.length, a = new Array(o > 1 ? o - 1 : 0), i = 1; i < o; i++)
          a[i - 1] = arguments[i];
        return (n = t.call(this, Qf.apply(void 0, [Xf[r]].concat(a))) || this), qs(n);
      }
      return e;
    })(Kr(Error));
    function Vs(t, e) {
    ...
    var jd = Object.create,
      ...
      Md = (t, e, r, n) => {
        if ((e && typeof e == 'object') || typeof e == 'function')
          for (let o of wu(e))
            !Nd.call(t, o) &&
              o !== r &&
              Au(t, o, { get: () => e[o], enumerable: !(n = Bd(e, o)) || n.enumerable });
        return t;
      },
      Ve = (t, e, r) => (
        (r = t != null ? jd(kd(t)) : {}),
        Md(e || !t || !t.__esModule ? Au(r, 'default', { value: t, enumerable: !0 }) : r, t)
      ),
      Ro = Ue({
      ...
      Zd = ({ status: t }) => {
        ...
        return x.createElement(Qd, { 'aria-label': 'Status of the test run', status: t }, e);
      },
      eh = fe.div(({ theme: t }) => ({
      ...
      ih = fe(rh)({ marginLeft: 9, marginRight: 9, marginBottom: 1, lineHeight: '12px' }),
      sh = fe(pr)(({ theme: t, animating: e, disabled: r }) => ({
        opacity: r ? 0.5 : 1,
        svg: { animation: e && `${t.animation.rotate360} 200ms ease-out` },
      })),
      uh = ({ controls: t, controlStates: e, status: r, storyFileName: n, onScrollToEnd: o }) => {
    ...
    var Do = (t) => Array.isArray(t) || (ArrayBuffer.isView(t) && !(t instanceof DataView)),
      ...
      ph = (t) => xu(t) || Do(t) || typeof t == 'function' || t instanceof Promise,
      Cu = (t) => {
        let e = /unique/;
      ...
      fh = (t, e, r) => Qe('root', t, 0, e === !1 ? e : !0, void 0, r === !1 ? r : !0),
      pu = Ve(zd()),
      dh = Ve(Ud()),
      hh = ['children'],
    ...
    var vh = Ve(Ro()),
      ...
      Ou = (t) => {
        ...
        return (
          ...
          x.createElement('span', (0, vh.default)({ className: Ze(s, a) }, i), u, f)
        );
      };
    ...
    var Fh = {
      ...
      Tu = (t, e) => {
        ...
        for (let r = e - 1; r >= 0; r -= 1)
          if (jh.test(t[r]) && r > 10) return `${t.slice(0, r).replace(du, '')}\u2026`;
      ...
      _t = ({ value: t, nested: e, showObjectInspector: r, callsById: n, ...o }) => {
        switch (!0) {
          ...
          case Object.prototype.toString.call(t) === '[object Object]':
            return x.createElement(qh, { value: t, showInspector: r, callsById: n, ...o });
          default:
      ...
      Wh = ({ prefix: t, localName: e, id: r, classNames: n = [], innerText: o }) => {
        let a = t ? `${t}:${e}` : e,
          i = Te();
        return x.createElement(
          'span',
...
`);
    ...
    var rm = fe.div(() => ({
      ...
      nm = fe('div', { shouldForwardProp: (t) => !['call', 'pausedAt'].includes(t.toString()) })(
        ({ theme: t, call: e }) => ({
          position: 'relative',
          display: 'flex',
      ...
      am = fe('button', { shouldForwardProp: (t) => !['call'].includes(t.toString()) })(
      ...
      im = fe.div({ padding: 6 }),
      sm = fe(sn)(({ theme: t }) => ({ color: t.textMutedColor, margin: '0 3px' })),
...
`),
                ...
                se(
                  ...
                  o?.length > 0 &&
                    se(
                      ...
                      {
                        hasChrome: !1,
                        tooltip: se(um, { note: `${i ? 'Show' : 'Hide'} interactions` }),
                      },
      ...
      fm = fe.div(({ theme: t }) => ({ width: 1, height: 16, backgroundColor: t.appBorderColor })),
      dm = () => {
        let [t, e] = We(!0),
      ...
      hm = fe.div(({ theme: t }) => ({ height: '100%', background: t.background.content })),
      gu = fe.div(({ theme: t }) => ({
        borderBottom: `1px solid ${t.appBorderColor}`,
        backgroundColor: t.base === 'dark' ? Qr(0.93, t.color.negative) : t.background.warning,
        padding: 15,

try {
  ;(() => {
    ...
    var x = __REACT__,
      {
        ...
        StrictMode: Dm,
        Suspense: Fm,
        __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Pm,
        cloneElement: jm,
        createContext: Bm,
        createElement: se,
        createFactory: km,
    ...
    var ny = __STORYBOOK_API__,
      {
        ActiveTabs: oy,
        Consumer: Mo,
        ManagerContext: ay,
        Provider: iy,
        RequestResponseError: sy,
        addons: on,
        combineParameters: uy,
        controlOrMetaKey: ly,
        controlOrMetaSymbol: cy,
        eventMatchesShortcut: py,
        eventToShortcut: fy,
        experimental_requestResponse: dy,
        isMacLike: hy,
        isShortcutTaken: my,
        keyToSymbol: yy,
        merge: gy,
        mockChannel: by,
        optionOrAltSymbol: vy,
        shortcutMatchesShortcut: Ey,
        shortcutToHumanString: Sy,
        types: Lo,
        useAddonState: an,
        useArgTypes: Ay,
        useArgs: wy,
        ...
        useStoryPrepared: _y,
        useStorybookApi: qo,
        useStorybookState: Iy
      } = __STORYBOOK_API__
    var Py = __STORYBOOK_COMPONENTS__,
      {
        A: jy,
        ActionBar: By,
        AddonPanel: Uo,
        ...
        codeCommon: _g,
        components: Ig,
        createCopyToClipboardFunction: Rg,
        getStoryHref: Tg,
        icons: Dg,
        interleaveSeparators: Fg,
        nameSpaceClassNames: Pg,
        resetComponents: jg,
        withReset: Bg
      } = __STORYBOOK_COMPONENTS__
    var $g = __STORYBOOK_CHANNELS__,
      {
        Channel: Xo,
        PostMessageTransport: zg,
        WebsocketTransport: qg,
        createBrowserChannel: Ug
      } = __STORYBOOK_CHANNELS__
    var Yg = __STORYBOOK_CLIENT_LOGGER__,
      {
        deprecate: rt,
        logger: Se,
        once: ct,
    ...
    var eb = __STORYBOOK_CORE_EVENTS__,
      {
        ...
        CONFIG_ERROR: Zo,
        CREATE_NEW_STORYFILE_REQUEST: nb,
        CREATE_NEW_STORYFILE_RESPONSE: ob,
        CURRENT_STORY_WAS_SET: pn,
        DOCS_PREPARED: ea,
        DOCS_RENDERED: Sr,
        FILE_COMPONENT_SEARCH_REQUEST: ab,
        FILE_COMPONENT_SEARCH_RESPONSE: ib,
        FORCE_REMOUNT: Xt,
        FORCE_RE_RENDER: Ar,
        GLOBALS_UPDATED: ta,
        NAVIGATE_URL: sb,
        ...
        PRELOAD_ENTRIES: ra,
        PREVIEW_BUILDER_PROGRESS: ub,
        PREVIEW_KEYDOWN: na,
        REGISTER_SUBSCRIPTION: lb,
        REQUEST_WHATS_NEW_DATA: cb,
        RESET_STORY_ARGS: xr,
        RESULT_WHATS_NEW_DATA: pb,
        SAVE_STORY_REQUEST: fb,
        SAVE_STORY_RESPONSE: db,
        SELECT_STORY: hb,
        SET_CONFIG: mb,
        ...
        SET_INDEX: yb,
        SET_STORIES: gb,
        SET_WHATS_NEW_CACHE: bb,
        SHARED_STATE_CHANGED: vb,
        SHARED_STATE_SET: Eb,
        STORIES_COLLAPSE_ALL: Sb,
        STORIES_EXPAND_ALL: Ab,
        ...
        STORY_UNCHANGED: pa,
        TELEMETRY_ERROR: wb,
        TOGGLE_WHATS_NEW_NOTIFICATIONS: xb,
...
`
              ...
              return (function i(s, u, l) {
                ...
                switch (g.slice(8, -1)) {
                  ...
                  case "Map":
                    ...
                    do
                      if (!i((p = f.next()).value, d.next().value, l)) return !1
                    while (!p.done)
                    return !0
                  case "ArrayBuffer":
    ...
    var rl = Object.create,
      ...
      ci = R((t, e) => {
        ;(function (r) {
          ...
          return c(function a(i, s, u) {
            ...
            c(l, "s")
            for (
              var f = typeof Dr == "function" && Dr, d = 0;
              d < u.length;
              d++
            )
              l(u[d])
                ...
                function (a, i, s) {
                  ...
                  i.exports = function (p) {
                    ...
                    return function (v) {
                      var b = c(function () {
                        ...
                        for (D = 0; D < w; D++) {
                          if (
                            ((C[D] = { cacheItem: m, arg: arguments[D] }),
                            m.has(arguments[D]))
                          ) {
                            m = m.get(arguments[D])
                            continue
                  ...
                  function f(p) {
                    ...
                    for (
                      ...
                      b >= 0 &&
                      ((h = p[b]), (v = h.cacheItem.get(h.arg)), !v || !v.size);
                      b--
                    )
      ...
      Vl = R((t, e) => {
        ...
        function i(s, u) {
          ...
          if (l instanceof r) {
            var f = l.__data__
            if (!n || f.length < a - 1)
              return f.push([s, u]), (this.size = ++l.size), this
      ...
      cc = R((t, e) => {
        ...
        function b(m, y, A, w, C, I) {
          ...
          if (L && !q)
            return (
              I || (I = new r()),
              D || l(m) ? n(m, y, A, w, C, I) : o(m, y, j, A, w, C, I)
            )
          if (!(A & f)) {
      ...
      Oc = R((t, e) => {
        ...
        function i(s, u, l) {
          var f = s[u]
          ;(!(a.call(s, u) && n(f, l)) || (l === void 0 && !(u in s))) &&
            r(s, u, l)
        }
      ...
      Pc = R((t, e) => {
        ...
        function o(a, i, s) {
          return (
            ...
            function () {
              for (
                var u = arguments, l = -1, f = n(u.length - i, 0), d = Array(f);
                ++l < f;
      ...
      qc = R((t, e) => {
        ...
        function s(u) {
          ...
          var l = n(u),
            f = []
          for (var d in u)
            (d == "constructor" && (l || !i.call(u, d))) || f.push(d)
          return f
        }
      ...
      ep = R((t, e) => {
        ...
        var r = "Function.prototype.bind called on incompatible ",
          ...
          s = c(function (l, f) {
            for (var d = [], p = f || 0, g = 0; p < l.length; p += 1, g += 1)
              d[g] = l[p]
            return d
          }, "slicy"),
          u = c(function (l, f) {
            for (var d = "", p = 0; p < l.length; p += 1)
              (d += l[p]), p + 1 < l.length && (d += f)
            return d
          }, "joiny")
      ...
      up = R((t, e) => {
        ...
        e.exports = c(function P(N, pe, S, O) {
          ...
          if ((c(me, "inspect"), typeof N == "function" && !ye(N))) {
            var Fe = _e(N),
              Ke = Ye(N, me)
            return (
              "[Function" +
...
` +
        ...
        var r = zt(),
          ...
          h = c(function (y, A) {
            for (var w = y, C; (C = w.next) !== null; w = C)
              if (C.key === A)
                return (w.next = C.next), (C.next = y.next), (y.next = C), C
          }, "listGetNode"),
          v = c(function (y, A) {
            var w = h(y, A)
            return w && w.value
      ...
      Mi = R((t, e) => {
        ...
        var r = Xn(),
          ...
          i = c(function (y) {
            for (; y.length > 1; ) {
              var A = y.pop(),
                w = A.obj[A.prop]
              if (o(w)) {
                for (var C = [], I = 0; I < w.length; ++I)
                  typeof w[I] < "u" && C.push(w[I])
                A.obj[A.prop] = C
              }
            }
          }, "compactQueue"),
          s = c(function (y, A) {
            for (
              var w = A && A.plainObjects ? Object.create(null) : {}, C = 0;
              C < y.length;
              ++C
            )
          ...
          g = c(function (y) {
            for (
              var A = [{ obj: { o: y }, prop: "o" }], w = [], C = 0;
              C < A.length;
              ++C
            )
              for (
                var I = A[C], D = I.obj[I.prop], E = Object.keys(D), j = 0;
                j < E.length;
                ++j
              ) {
                var z = E[j],
            ...
            return {
              ...
              serializeDate:
                typeof m.serializeDate == "function"
                  ...
                  : p.serializeDate,
              skipNulls:
                typeof m.skipNulls == "boolean" ? m.skipNulls : p.skipNulls,
      ...
      pp = R((t, e) => {
        ...
        var r = Mi(),
          ...
          s = c(function (h, v) {
            return h && typeof h == "string" && v.comma && h.indexOf(",") > -1
              ? h.split(",")
              : h
          }, "parseArrayValue"),
          ...
          p = c(function (h, v, b, m) {
            if (h) {
              ...
              for (
                var E = 0;
                b.depth > 0 && (C = w.exec(y)) !== null && E < b.depth;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
    ...
    var dt = Ui(),
      Hi = class {
        ...
        addRenderListeners() {
          this.removeRenderListeners(),
            dt.getChannel().on(Qt, this.renderListener)
        }
...
`
    ...
    function ss(t) {
      ...
      return n.startsWith("{") && n.endsWith("}")
        ? _n(n.slice(1, -1).replace(/\s/g, "")).map((o) =>
            o.replace(/:.*|=.*/g, "")
          )
        : []
    }
    ...
    function ao(t, e, r) {
      let { moduleExport: n, id: o, name: a } = t || {},
        ...
        s = c(async (C) => {
          let I = {}
          for (let D of [
            ...("__STORYBOOK_TEST_LOADERS__" in Re &&
            Array.isArray(Re.__STORYBOOK_TEST_LOADERS__)
      ...
      `),
            ...
            : (r.add(t),
              Array.isArray(t)
                ...
                : {
                    name: "object",
                    value: (0, In.default)(t, (o) => Rn(o, e, new Set(r)))
                  })
          : { name: "object", value: {} }
      }, "inferType"),
      ls = c((t) => {
        let { id: e, argTypes: r = {}, initialArgs: n = {} } = t,
          o = (0, In.default)(n, (i, s) => ({
            name: s,
    ...
    function Zp(t, e, r) {
      ...
      return Object.entries(i).reduce(
        (s, [u, l]) =>
          Tr(u, n) ? Object.assign(s, { [u]: r(l, n, e, u) }) : s,
        {}
      )
    }
    c(Zp, "composeStories")
  ...
  `)
        ...
        if (!n) {
          e === "*"
            ...
            : this.renderStoryLoadingException(
                e,
                new Ra({ storySpecifier: e.toString() })
              )
          return
        }
        let { id: o, type: a } = n
      ...
      async renderSelection({ persistedArgs: e } = {}) {
        ...
        try {
          ...
          f && (await this.teardownRender(f)),
            p !== Vr && this.renderStoryLoadingException(o, p)
          return
        }
    ...
    var Af = js,
      ...
      ks = class {
        ...
        constructor() {
          if (typeof De < "u") {
            let { __SPECIAL_TEST_PARAMETER__: e } = xf.default.parse(
              De.location.search,
              { ignoreQueryPrefix: !0 }
            )
            switch (e) {
        ...
        showMode(e) {
          clearTimeout(this.preparingTimeout),
            Object.keys(Bs).forEach((r) => {
              r === e
                ? De.body.classList.add(Sn[r])
                : De.body.classList.remove(Sn[r])
            })
        }
...
`
    ...
    var u0 = __STORYBOOK_CLIENT_LOGGER__,
      {
        deprecate: l0,
        logger: c0,
        once: Tf,
            ...
            l
              .map(
                (v) =>
                  f.spacingOuter +
                  d +
                  (typeof v == "string" ? a(v, f) : h(v, f, d, p, g))
              )
              .join("")
          t.printChildren = o
          var a = (l, f) => {
        ...
        "../../node_modules/pretty-format/build/plugins/DOMElement.js"(t) {
          ...
          var e = co(),
            ...
            s = (b) => {
              try {
                return (
                  typeof b.hasAttribute == "function" && b.hasAttribute("is")
                )
              } catch {
                return !1
              }
            ...
            return ++A > m.maxDepth
              ...
              : (0, e.printElement)(
                  ...
                  (0, e.printProps)(
                    ...
                    p(b)
                      ? {}
                      : Array.from(b.attributes).reduce(
        ...
        "../../node_modules/diff-sequences/build/index.js"(t) {
          ...
          var e = "diff-sequences",
                ...
                if (((_ = w[B]), (w[B] = te), G <= H && H <= L)) {
                  ...
                  if (ue <= D && I[ue] - 1 <= te) {
                    ...
                    ;(E.nChangePreceding = h - 1),
                      ...
                      le !== 0 &&
                        ((E.aCommonPreceding = Ee), (E.bCommonPreceding = T)),
            ...
            l = (h, v, b, m, y, A, w, C, I) => {
              ...
              if (((w[0] = v - 1), (C[0] = b), q % 2 === 0)) {
                ...
                for (G = a(B, b, y, D, A, w, G), B += 1; B <= F; B += 1)
                  if (((L = i(B - 1, v, m, E, A, C, L)), B < _))
                    G = a(B, b, y, D, A, w, G)
                  else if (s(B, v, b, m, y, A, w, G, C, L, I)) return
              }
              throw new Error(
                `${e}: no overlap aStart=${v} aEnd=${b} bStart=${m} bEnd=${y}`
              )
            },
            ...
            d = (h, v) => {
              if (typeof v != "number")
                throw new TypeError(
                  `${e}: ${h} typeof ${typeof v} is not a number`
                )
              if (!Number.isSafeInteger(v))
                throw new RangeError(
                  `${e}: ${h} value ${v} is not a safe integer`
                )
              if (v < 0)
                throw new RangeError(
                  `${e}: ${h} value ${v} is a negative integer`
                )
            },
            p = (h, v) => {
              let b = typeof v
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
            ...
            function G(S, O) {
              ...
              return k
                ? O.stylize(
                    "[Function ".concat(v(k, O.truncate - 11), "]"),
                    "special"
                  )
            ...
            function F(S, O) {
              ...
              return k <= 0
                ? "Map{}"
                : ((O.truncate -= 7), "Map{ ".concat(b(_(S), O, L), " }"))
            }
            var B =
              Number.isNaN ||
              function (S) {
            ...
            function V(S, O) {
              return S.size === 0
                ? "Set{}"
                : ((O.truncate -= 7), "Set{ ".concat(b(M(S), O), " }"))
            }
            var J = new RegExp(
                "['\\u0000-\\u001f\\u007f-\\u009f\\u00ad\\u0600-\\u0604\\u070f\\u17b4\\u17b5\\u200c-\\u200f\\u2028-\\u202f\\u2060-\\u206f\\ufeff\\ufff0-\\uffff]",
                "g"
...
`
            ...
            function Wt(S, O) {
              ...
              return (
                me &&
                  me.length > we &&
                  (me = "".concat(p, "(").concat(S.children.length, ")")),
            ...
            function Ye(S, O) {
              ...
              var k = O,
                Y = k.customInspect,
                X = S === null ? "null" : n(S)
              if ((X === "object" && (X = Tt.call(S).slice(8, -1)), Gt[X]))
                return Gt[X](S, O)
              if (Y && S) {
                var Z = mr(S, O, X)
    ...
    fo.open = ""
    fo.close = ""
    var D0 = Kf.reduce((t, [e]) => ((t[e] = fo), t), { isColorSupported: !1 })
    var {
...
`
    ...
    var Me = (function (t) {
      ...
      function e(r) {
        for (
          ...
          a[i - 1] = arguments[i]
        return (
          (n = t.call(this, Qf.apply(void 0, [Xf[r]].concat(a))) || this), qs(n)
        )
      }
      return e
    })(Kr(Error))
    ...
    function lr(t, e, r, n) {
      if ((n === void 0 && (n = td), e === 0)) return n(r, r, r)
    ...
    function qt(t) {
      ...
      var a = sd.exec(e.substring(0, 50))
      if (a)
        return {
          red: parseInt("" + a[1], 10),
      ...
      var p = ld.exec(e.substring(0, 50))
      if (p) {
    ...
    function Id(t, e) {
      return e === "transparent"
        ? e
        : gt(Be({}, yt(e), { lightness: parseFloat(t) }))
    }
    var Pv = ze(Id)
    function Rd(t, e) {
      return e === "transparent"
        ? e
        : gt(Be({}, yt(e), { saturation: parseFloat(t) }))
    }
    var jv = ze(Rd)
    function Td(t, e) {
    ...
    var Pd = ze(Fd),
      Qr = Pd
    var zv = __STORYBOOK_ICONS__,
      {
        AccessibilityAltIcon: qv,
        AccessibilityIcon: Uv,
        AddIcon: Hv,
        AdminIcon: Wv,
        AlertAltIcon: Vv,
        AlertIcon: Gv,
        ...
        BoldIcon: dE,
        BookIcon: hE,
        BookmarkHollowIcon: mE,
        BookmarkIcon: yE,
        BottomBarIcon: gE,
        BottomBarToggleIcon: bE,
        BoxIcon: vE,
        BranchIcon: EE,
        BrowserIcon: SE,
        ButtonIcon: AE,
        ...
        ChevronLeftIcon: DE,
        ChevronRightIcon: FE,
        ChevronSmallDownIcon: PE,
        ChevronSmallLeftIcon: jE,
        ChevronSmallRightIcon: BE,
        ChevronSmallUpIcon: kE,
        ChevronUpIcon: NE,
        ChromaticIcon: ME,
        ChromeIcon: LE,
        CircleHollowIcon: $E,
        ...
        SideBySideIcon: JA,
        SidebarAltIcon: XA,
        SidebarAltToggleIcon: QA,
        SidebarIcon: ZA,
        SidebarToggleIcon: ew,
        SpeakerIcon: tw,
        StackedIcon: rw,
        StarHollowIcon: nw,
        StarIcon: ow,
    ...
    var jd = Object.create,
        ...
        if ((e && typeof e == "object") || typeof e == "function")
          for (let o of wu(e))
            !Nd.call(t, o) &&
              ...
              Au(t, o, {
                get: () => e[o],
                enumerable: !(n = Bd(e, o)) || n.enumerable
              })
        return t
      },
      Ve = (t, e, r) => (
      ...
      Kd = `${en}/panel`,
      Jd = "https://youtu.be/Waht9qq7AoA",
      Xd = "writing-tests/interaction-testing",
      Qd = fe.div(({ theme: t, status: e }) => ({
      ...
      sh = fe(pr)(({ theme: t, animating: e, disabled: r }) => ({
        opacity: r ? 0.5 : 1,
          ...
          x.createElement(
            ...
            x.createElement(
              ...
              x.createElement(
                cu,
                null,
                x.createElement(Zd, { status: r }),
                x.createElement(ih, { onClick: o, disabled: !o }, a),
                x.createElement(nh, null),
                x.createElement(
                  Et,
                  {
                    trigger: "hover",
              ...
              n && x.createElement(cu, null, x.createElement(oh, null, n))
            )
          )
        )
      },
    ...
    var Do = (t) =>
      ...
      ph = (t) =>
        xu(t) || Do(t) || typeof t == "function" || t instanceof Promise,
      Cu = (t) => {
        let e = /unique/
      ...
      Eo = Ve(Vd()),
      yh = Ve(Yd()),
      gh = x.createContext({ isChild: !1, depth: 0, hasHover: !0 }),
      So = gh,
      Le = {
      ...
      Zr = (t) => {
        let {
          ...
          f = (0, yh.default)(t, bh),
          { themeClass: d, currentTheme: p } = tn(
    ...
    var vh = Ve(Ro()),
      ...
      Sh = ["ast", "theme", "showKey", "colorScheme", "className"],
      $e = (t, e, r, n, o) => {
      ...
      Ou = (t) => {
        ...
        return (
          ...
          x.createElement(
            "span",
            (0, vh.default)({ className: Ze(s, a) }, i),
            u,
            f
          )
        )
    ...
    var _u = Ou,
      Ht = Ve(Ro()),
      Ah = Ve(To()),
      wh = ["ast", "theme", "previewMax", "open", "colorScheme", "className"],
      fr = (t, e, r) => {
        let n = []
      ...
      Iu = (t) => {
        let {
          ...
          s = (0, Ah.default)(t, wh),
          { themeClass: u, currentTheme: l } = tn(
          ...
          o
            ? x.createElement(
                Zr,
                {
                  hover: !1,
                  open: i,
                  label: x.createElement(Rh, { open: i, ast: o }),
                  onSelect: () => {
                    var u
    ...
    var Th = Fo,
      ...
      Ru = (t) => {
        ...
        return (
          lt(() => {
            ;(async () => d(await fh(e, n, o)))()
          }, [e, n, o]),
          x.createElement(
            "div",
            (0, lh.default)({ className: Ze(Ae.objectInspector, a, p) }, l),
            f &&
              x.createElement(
                mh,
                { theme: g, colorScheme: h },
                x.createElement(Th, { ast: f, expandLevel: r, onSelect: u })
              )
          )
        )
      }
    ...
    var Fh = {
      ...
      _t = ({
        ...
        switch (!0) {
          ...
          default:
            return x.createElement(Jh, { value: t, ...o })
        }
      },
      kh = (t) => {
        let e = Te()
      ...
      qh = ({ showInspector: t, value: e, callsById: r, nested: n = !1 }) => {
        let o = ur().base === "dark",
          a = Te()
        if (t)
          return x.createElement(
      ...
      Vh = ({ value: t }) => {
        ...
        return x.createElement(
          ...
          r === "00:00:00"
            ? x.createElement("span", { style: { opacity: 0.7 } }, r)
            : r,
          n === "000"
            ? x.createElement("span", { style: { opacity: 0.7 } }, ".", n)
            : `.${n}`,
      ...
      Kh = ({ description: t }) => {
        ...
        return x.createElement(
          ...
          "Symbol(",
          t &&
            x.createElement("span", { style: { color: e.meta } }, '"', t, '"'),
          ")"
        )
      },
      Jh = ({ value: t }) => {
        let e = Te()
        return x.createElement("span", { style: { color: e.meta } }, Bh(t))
      },
      Xh = ({ label: t }) => {
        let e = Te(),
          { typography: r } = ur()
      ...
      Po = ({ call: t, callsById: e }) => {
        ...
        if (t.method === "step" && t.path.length === 0)
          return x.createElement(Xh, { label: t.args[0] })
...
`)
      ...
      Fu = ({ status: t }) => {
        ...
        switch (t) {
          case de.DONE:
            return x.createElement(Qs, {
              color: e.color.positive,
              "data-testid": "icon-done"
            })
          case de.ERROR:
            return x.createElement(su, {
              color: e.color.negative,
              "data-testid": "icon-error"
            })
          case de.ACTIVE:
            return x.createElement(ou, {
    ...
    var rm = fe.div(() => ({
      ...
      om = fe.div(({ theme: t, isInteractive: e }) => ({
        display: "flex",
      ...
      um = fe(ln)(({ theme: t }) => ({ fontFamily: t.typography.fonts.base })),
      yu = fe("div")(({ theme: t }) => ({
        padding: "8px 10px 8px 36px",
        fontSize: st.size.s1,
...
`),
                ...
                se(
                  ...
                  o?.length > 0 &&
                    se(
                      ...
                      se(sm, { onClick: s }, se(ru, null))
                    )
                )
              ),
              t.status === de.ERROR &&
                t.exception?.callId === t.id &&
                se(lm, { exception: t.exception })
            )
      },
      pm = fe.div(({ theme: t }) => ({
        display: "flex",
      ...
      dm = () => {
        let [t, e] = We(!0),
          r = qo().getDocsUrl({ subpath: Xd, versioned: !0, renderer: !0 })
        return (
          lt(() => {
            let n = setTimeout(() => {
              e(!1)
          ...
          t
            ...
            : x.createElement(Go, {
                ...
                footer: x.createElement(
                  ...
                  x.createElement(
                    un,
                    { href: Jd, target: "_blank", withArrow: !0 },
                    x.createElement(lu, null),
                    " Watch 8m video"
                  ),
                  x.createElement(fm, null),
                  x.createElement(
                    un,
      ...
      gu = fe.div(({ theme: t }) => ({
        borderBottom: `1px solid ${t.appBorderColor}`,
        backgroundColor:
          t.base === "dark" ? Qr(0.93, t.color.negative) : t.background.warning,
        padding: 15,
        fontSize: t.typography.size.s2 - 1,
        lineHeight: "19px"
      })),
      ...
      mm = fe.p({ margin: 0, padding: "0 0 20px" }),
      vu = fe.pre(({ theme: t }) => ({
        margin: 0,
        padding: 0,
        ...
        return se(
          ...
          s &&
            se(
              ...
              s.map((p, g) =>
                se(vu, { key: g, "data-chromatic": "ignore" }, Eu(p))
              )
            ),
          se("div", { ref: d }),
          !u && !i && n.length === 0 && se(dm, null)
        )
      })
    function Eu(t) {
    ...
    function vm() {
      ...
      return x.createElement(
        ...
        x.createElement(
          ...
          e ? x.createElement(bm, { status: de.ERROR }) : null
        )
      )
    }
    on.register(en, (t) => {

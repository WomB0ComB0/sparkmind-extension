try {
  (() => {
    ...
    var _n = __STORYBOOK_API__,
      {
        ...
        shortcutMatchesShortcut: Un,
        shortcutToHumanString: kn,
        types: Ne,
        useAddonState: xe,
        useArgTypes: Gn,
        useArgs: Wn,
    ...
    var ra = __STORYBOOK_CORE_EVENTS__,
      {
        ARGTYPES_INFO_REQUEST: na,
        ARGTYPES_INFO_RESPONSE: aa,
        CHANNEL_CREATED: oa,
        CHANNEL_WS_DISCONNECT: ia,
        CONFIG_ERROR: sa,
        CREATE_NEW_STORYFILE_REQUEST: la,
        CREATE_NEW_STORYFILE_RESPONSE: ua,
        CURRENT_STORY_WAS_SET: ca,
        DOCS_PREPARED: pa,
        DOCS_RENDERED: fa,
        FILE_COMPONENT_SEARCH_REQUEST: da,
        FILE_COMPONENT_SEARCH_RESPONSE: ma,
        FORCE_REMOUNT: ga,
        FORCE_RE_RENDER: ba,
        GLOBALS_UPDATED: ha,
        NAVIGATE_URL: Ea,
        PLAY_FUNCTION_THREW_EXCEPTION: ya,
        PRELOAD_ENTRIES: Oa,
        PREVIEW_BUILDER_PROGRESS: Ta,
        PREVIEW_KEYDOWN: va,
        REGISTER_SUBSCRIPTION: _a,
        REQUEST_WHATS_NEW_DATA: Sa,
        RESET_STORY_ARGS: Ra,
        RESULT_WHATS_NEW_DATA: Aa,
        SAVE_STORY_REQUEST: Ca,
        SAVE_STORY_RESPONSE: wa,
        SELECT_STORY: Na,
        SET_CONFIG: xa,
        SET_CURRENT_STORY: La,
        SET_GLOBALS: Ia,
        SET_INDEX: Da,
        SET_STORIES: Ma,
        SET_WHATS_NEW_CACHE: Pa,
        SHARED_STATE_CHANGED: Ba,
        SHARED_STATE_SET: Fa,
        STORIES_COLLAPSE_ALL: za,
        STORIES_EXPAND_ALL: Ha,
        STORY_ARGS_UPDATED: ja,
        STORY_CHANGED: k,
        STORY_ERRORED: Ua,
        STORY_INDEX_INVALIDATED: ka,
        STORY_MISSING: Ga,
        STORY_PREPARED: Wa,
        STORY_RENDERED: Va,
        STORY_RENDER_PHASE_CHANGED: $a,
        STORY_SPECIFIED: Ya,
        STORY_THREW_EXCEPTION: Ja,
        STORY_UNCHANGED: qa,
        TELEMETRY_ERROR: Xa,
        TOGGLE_WHATS_NEW_NOTIFICATIONS: Za,
        UNHANDLED_ERRORS_WHILE_PLAYING: Ka,
        UPDATE_GLOBALS: Qa,
    ...
    var po = __STORYBOOK_COMPONENTS__,
      {
        ...
        codeCommon: mi,
        components: gi,
        createCopyToClipboardFunction: bi,
        getStoryHref: hi,
        icons: Ei,
        interleaveSeparators: yi,
        nameSpaceClassNames: Oi,
        resetComponents: Ti,
        withReset: vi,
...
`,
    ...
    var v = (function (e) {
      ...
      function t(r) {
        for (var n, a = arguments.length, i = new Array(a > 1 ? a - 1 : 0), s = 1; s < a; s++)
          i[s - 1] = arguments[s];
        return (n = e.call(this, ft.apply(void 0, [pt[r]].concat(i))) || this), He(n);
      }
      return t;
    })(W(Error));
    function Ge(e, t) {
    ...
    var mt = function (t) {
        return function (r, n) {
          ...
          var a = r,
            i = n;
          if (typeof r == 'string') {
            if (!Ge(r, 'px')) throw new v(69, t, r);
            a = We(r);
          }
          if (typeof n == 'string') {
            if (!Ge(n, 'px')) throw new v(70, t, n);
            i = We(n);
          }
    ...
    var Er = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      Nr = (e) => o.createElement(at, { nodeRenderer: Cr, dataIterator: wr, ...e }),
      xr = de(Nr),
      Lr = er(nr()),
      Ir = ({ table: e = !1, data: t, ...r }) =>
        e
          ? o.createElement(_r, { data: t, ...r })
          : (0, Lr.default)(t)
    ...
    var Br = B(st)({ margin: 0, padding: '10px 5px 20px' }),
      Fr = ze(({ theme: e, ...t }) =>
